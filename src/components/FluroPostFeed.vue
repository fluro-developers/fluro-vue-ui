																				...
																				<fluro-panel-title>
																								<v-layout align-center>
																												...
																												<v-flex>
																																...
																																<div class="muted font-xs">Posted by {{post.managedAuthor ? post.managedAuthor.title : post.author ? post.author.name : 'Someone'}}</div>
																												</v-flex>
																												<v-flex shrink>
																																<v-btn small class="my-0" icon @click="edit(post)" v-if="$fluro.access.canEditItem(post)">
								...
								feed: {
												...
												get() {
																...
																return new Promise(function(resolve, reject) {
																				...
																				return self.$fluro.api.get(`/post/${id}/all`)
																								.then(function(res) {
