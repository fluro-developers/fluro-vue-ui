        ...
        switch (self.type) {
          ...
          case "article":
            return DynamicImportService.load(
              "src/components/content/view/panels/article.vue",
              function() {
          ...
          case "audio":
            return DynamicImportService.load(
              "src/components/content/view/panels/audio.vue",
              function() {
          ...
          case "collection":
            return DynamicImportService.load(
              "src/components/content/view/panels/collection.vue",
              function() {
                return import(
                  "src/components/content/view/panels/collection.vue"
                );
          ...
          case "contact":
            return DynamicImportService.load(
              "src/components/content/view/panels/contact.vue",
              function() {
          ...
          case "contactdetail":
            return DynamicImportService.load(
              "src/components/content/view/panels/contactdetail.vue",
              function() {
                return import(
                  "src/components/content/view/panels/contactdetail.vue"
                );
          ...
          case "event":
            return DynamicImportService.load(
              "src/components/content/view/panels/event.vue",
              function() {
          ...
          case "family":
            return DynamicImportService.load(
              "src/components/content/view/panels/family.vue",
              function() {
          ...
          case "image":
            return DynamicImportService.load(
              "src/components/content/view/panels/image.vue",
              function() {
          ...
          case "interaction":
            return DynamicImportService.load(
              "src/components/content/view/panels/interaction.vue",
              function() {
                return import(
                  "src/components/content/view/panels/interaction.vue"
                );
          ...
          case "mailout":
            return DynamicImportService.load(
              "src/components/content/view/panels/mailout.vue",
              function() {
          ...
          case "plan":
            return DynamicImportService.load(
              "src/components/content/view/panels/plan.vue",
              function() {
          ...
          case "post":
            return DynamicImportService.load(
              "src/components/content/view/panels/post.vue",
              function() {
          ...
          case "query":
            return DynamicImportService.load(
              "src/components/content/view/panels/query.vue",
              function() {
          ...
          case "tag":
            return DynamicImportService.load(
              "src/components/content/view/panels/tag.vue",
              function() {
          ...
          case "ticket":
            return DynamicImportService.load(
              "src/components/content/view/panels/ticket.vue",
              function() {
          ...
          case "video":
            return DynamicImportService.load(
              "src/components/content/view/panels/video.vue",
              function() {
