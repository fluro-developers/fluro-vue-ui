						...
						<v-input class="no-flex" label="Contact">
							<v-layout align-center>
								...
								<v-flex shrink style="padding-right: 10px">
									<v-btn
										class="ma-0"
										v-if="$fluro.access.canEditItem(item.contact)"
										icon
										@click="$fluro.global.edit(item.contact, true)"
									>
						...
						<v-input class="no-flex" label="User Persona">
							<v-layout align-center>
								...
								<v-flex shrink style="padding-right: 10px">
									<v-btn
										class="ma-0"
										v-if="$fluro.access.canEditItem(item.persona)"
										icon
										@click="$fluro.global.edit(item.persona, true)"
									>
										<fluro-icon icon="pencil" />
									</v-btn>
