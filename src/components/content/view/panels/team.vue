																				...
																				<v-container fluid>
																								<constrain sm>
																												...
																												<fluro-panel v-for="group in groups">
																																<fluro-panel-title>
																																				<strong>{{group.contacts.length}} {{group.title}}</strong> <span class="muted" v-if="searchWords">Matching: '{{searchWords}}'</span>
																																</fluro-panel-title>
																																<fluro-table :pageSize="20" :scrollable="false" :items="group.contacts" :columns="columns">
																																</fluro-table>
																																<!-- <fluro-panel> -->
																																<!-- </fluro-panel> -->
																												</fluro-panel>
																												<fluro-panel v-if="members.length">
																																<fluro-panel-title>
																																				<strong>{{members.length}} Provisional Members</strong> <span class="muted" v-if="searchWords">Matching: '{{searchWords}}'</span>
																																</fluro-panel-title>
																																<fluro-table :pageSize="20" :scrollable="false" :items="members" :columns="columns">
																																</fluro-table>
																																<!-- <fluro-panel> -->
																																<!-- </fluro-panel> -->
																												</fluro-panel>
...
export default {
				...
				computed: {
					readableTypeName() {
            return this.definition ? this.$fluro.types.readable(this.definition.title) : 'Team';
        },
								searchWords() {
