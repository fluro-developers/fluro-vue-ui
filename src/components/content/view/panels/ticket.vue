		...
		<v-container fluid>
			<constrain sm>
				...
				<v-input class="no-flex" v-if="item.email">
					<v-label> Primary Email Address </v-label>
					<div>
						{{ item.email }}
					</div>
				</v-input>
				...
				<v-input class="no-flex" v-if="item.contact">
					...
					<fluro-list-item
						@click.native="$fluro.global.view(item.contact)"
						:bordered="true"
						:item="item.contact"
					/>
				</v-input>
				...
				<v-input class="no-flex" v-if="item.event">
					...
					<fluro-list-item
						@click.native="$fluro.global.view(item.event)"
						:bordered="true"
						:item="item.event"
					/>
				</v-input>
				...
				<v-input class="no-flex" v-if="item.interaction">
					<v-label> Interaction </v-label>
					<fluro-list-item
						@click.native="$fluro.global.view(item.interaction)"
						:bordered="true"
