				...
				<flex-column class="content-edit">
								...
								<template v-else>
												...
												<form class="flex-column" @submit.prevent :disabled="state == 'processing'">
																...
																<component @errorMessages="validate" :save="submitUpdate" ref="form" :context="context" @refresh="refresh" @input="updateModel" v-bind:is="component" :type="typeConfig" :config="config" v-model="model" @file="fileChanged" :definition="definition" v-if="component"></component>
