			...
			<v-layout align-center>
				...
				<v-flex shrink>
					...
					<template v-if="editMode">
						<v-btn class="mx-0" small @click="cancel()">
							Cancel
						</v-btn>
		...
		<fluro-panel-body v-if="editMode">
			<fluro-content-form v-model="model" :fields="fields">
				<template v-slot:form="{formFields, fieldHash, model, update, options}">
					<fluro-content-form-field :form-fields="formFields" @input="update" :options="options" :field="fieldHash.title" v-model="model" />
					<fluro-content-form-field :form-fields="formFields" @input="update" :options="options" :field="fieldHash.autoRecur" v-model="model" />
					<template v-if="model.autoRecur">
						<fluro-content-form-field :form-fields="formFields" @input="update" :options="options" :field="fieldHash.recurDefinition" v-model="model" />
						<v-layout>
							<v-flex>
								<fluro-content-form-field :form-fields="formFields" @input="update" :options="options" :field="fieldHash.nextRecurDate" v-model="model" />
							</v-flex>
							<v-spacer />
							<v-flex>
						...
						<v-layout>
							<v-flex>
								<fluro-content-form-field :form-fields="formFields" @input="update" :options="options" :field="fieldHash.recurCount" v-model="model" />
							</v-flex>
							<v-spacer />
							<v-flex>
								<fluro-content-form-field :form-fields="formFields" @input="update" :options="options" :field="fieldHash.recurMeasure" v-model="model" />
							</v-flex>
							<v-spacer />
							<v-flex>
								<fluro-content-form-field :form-fields="formFields" @input="update" :options="options" :field="fieldHash.recurNth" v-model="model" />
							</v-flex>
							<v-flex>
								<fluro-content-form-field :form-fields="formFields" @input="update" :options="options" :field="fieldHash.recurWeekday" v-model="model" />
							</v-flex>
						</v-layout>
						<v-layout>
							<v-flex>
								<fluro-content-form-field :form-fields="formFields" @input="update" :options="options" :field="fieldHash.defaultStartTime" v-model="model" />
							</v-flex>
							<v-spacer />
							<v-flex>
								<fluro-content-form-field :form-fields="formFields" @input="update" :options="options" :field="fieldHash.defaultDuration" v-model="model" />
							</v-flex>
							<v-spacer />
							<v-flex>
								<fluro-content-form-field :form-fields="formFields" @input="update" :options="options" :field="fieldHash.defaultTimezone" v-model="model" />
							</v-flex>
						</v-layout>
					</template>
				</template>
...
export default {
	...
	methods: {
		save() {
			...
			self.$fluro.api.put(`/content/${self.model.definition || 'eventtrack'}/${self.model._id}`, self.model)
				.then(function(res) {
