...
export default {
	...
	methods: {
		...
		edit(index) {
			var self = this;
			self.$fluro.prompt(self.fields, 'Edit room', self.model[index]).then(function (res) {
			...
			addField('row', {
				...
				fields: [
					...
					},
					{
						...
						type: 'string',
						description:
							'An ID used to link with external services, like booking systems or image recognition services',
						key: 'externalID',
					},
					// {
					//     title: 'Add',
