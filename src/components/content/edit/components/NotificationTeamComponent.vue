                ...
                <v-container fluid pa-0>
                    <template v-if="editMode">
                        <v-layout row wrap grid-list-xl py-0>
                            <v-flex sm6 xs6>
                                <fluro-content-form-field :form-fields="formFields" @input="update" :options="options" :field="fieldHash.trigger" v-model="model" />
                            </v-flex>
                            <v-flex sm6 xs6>
                                <fluro-content-form-field :form-fields="formFields" @input="update" :options="options" :field="fieldHash.assignments" v-model="model" />
                            </v-flex>
                        </v-layout>
                    </template>
                    <template v-else>
...
export default {
    ...
    computed: {
        triggerLookup() {
            return _.reduce(this.triggers, function(set, trigger) {
