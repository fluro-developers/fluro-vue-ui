							...
							<v-layout align-start row wrap>
								...
								<v-flex sm8 xs12>
									<path-selector
										...
										@pathupdated="pathUpdated(index, ...arguments)"
									/>
								</v-flex>
								<!-- <v-flex sm8 xs12>
                                    <v-select/>
				...
				<form @submit.prevent.stop="add()">
					<v-container fluid grid-list-xl pa-1>
						<v-layout row wrap grid-list-xl>
								...
								<v-layout row wrap>
									...
									<v-flex sm8 xs12>
										<path-selector
											...
											:options="columnKeyOptions"
											@pathupdated="proposedPathUpdated"
											:loading="loadingSample"
										/>
									</v-flex>
								</v-layout>
							...
							<v-flex sm2 xs12>
								<v-btn block color="primary" type="submit" @click="add()" :disabled="!proposed.key"
									>Add</v-btn
								>
							</v-flex>
						</v-layout>
