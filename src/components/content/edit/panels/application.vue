  ...
  computed: {
    ...
    fieldsOutput() {
      ...
      addField("domain", {
        ...
        type: "string",
        description:
          "Add a domain name for this application (without https://)",
      ...
      addField("forwards", {
        ...
        type: "string",
        description:
          "Add domain names that should redirect to the primary domain name",
      ...
      addField("apipath", {
        ...
        type: "string",
        description:
          "Specify which API URL this application should use. If left blank, the default fluro api url will be used.",
      ...
      addField("gaTrackingCode", {
        ...
        description:
          "Paste your GA tracking code to enable google analytics to track this site"
      });
      ...
      addField("headerInject", {
        ...
        description:
          "Include HTML that can be injected above the closing </head> tag"
      });
      ...
      addField("footerInject", {
        ...
        description:
          "Include HTML that can be injected above the closing </body> tag"
      });
