							...
							<div class="grid-list-xl">
								...
								<fluro-panel>
									<fluro-panel-title>
										...
										<div class="font-sm">
											Information for accessing this application in your browser
										</div>
									</fluro-panel-title>
									<fluro-panel-body>
										<!-- <v-layout> -->
								...
								<fluro-panel v-if="$pro.enabled">
									<fluro-panel-title>
										...
										<div class="font-sm">
											Information for this application if published as a native iOS / Android
											Application
										</div>
									</fluro-panel-title>
									<fluro-panel-body>
						...
						<constrain sm>
							<div class="grid-list-xl">
								<fluro-content-form-field
									...
									@input="update"
									:options="options"
									:field="fieldHash.authenticationStyle"
									v-model="model"
								/>
								<fluro-panel v-if="model.authenticationStyle == 'application'">
									<fluro-panel-body>
										<v-input
											class="no-flex"
											hint="Use this key to authenticate with the API as this application"
										...
										>
											<div
												...
												@click.stop.prevent="$fluro.global.copyToClipBoard(apiKey)"
											>
				...
				<flex-column-body style="background: #fafafa">
					<v-container>
						<constrain sm>
							...
							<p>
								Add permissions here that will be attributed to a logged in user when signed in to this
								application. These will be merged with any existing permissions retrieved from a user's
								managed persona in the '{{ model.title }}' account
							</p>
					...
					<v-container>
						<constrain sm>
							...
							<fluro-content-form-field
								...
								@input="update"
								:options="options"
								:field="fieldHash.gaTrackingCode"
								v-model="model.data"
							/>
							<fluro-content-form-field
								:form-fields="formFields"
