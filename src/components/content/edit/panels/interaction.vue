									...
									<tabset :justified="true">
										<tab heading="Submitted Data">
											<fluro-panel-body class="border-bottom"
												>This is the data that was provided at the time of
												submission.</fluro-panel-body
											>
											<fluro-panel-body>
												<fluro-content-form
													:options="options"
										...
										<tab heading="Computed Data">
											<fluro-panel-body class="border-bottom"
												>This is the data after it has been processed by the system. Your form
												may have content that is transformed into dynamic links to other content
												in the database, eg. contacts, families etc</fluro-panel-body
											>
											<fluro-panel-body>
												<fluro-content-form
													:options="options"
...
export default {
	...
	computed: {
		...
		askDOB() {
			return (
				_.get(this.definition, 'data.askDOB') || _.get(this.definition, 'data.requireDOB') || this.model._dob
			);
		},
		fieldsOutput() {
			var self = this;
