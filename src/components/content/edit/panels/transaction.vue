                    ...
                    <flex-column-body style="background: #fafafa;">
                        <v-container fluid>
                            <constrain sm v-if="model._id">
                                ...
                                <fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.email" v-model="model" />
    ...
    computed: {
        ...
        fieldsOutput() {
            ...
            addField('email', {
                ...
                minimum: 0,
                maximum: 1,
                description: 'The email address to be linked for this transaction (this is where receipts are sent to and is usually the email address of the payer)',
                type: 'email',
            });
