                                ...
                                <constrain sm>
                                    <fluro-panel>
                                        ...
                                        <fluro-panel-body v-if="definedFields.length">
                                            <fluro-content-form :options="editorOptions" v-model="model.data" :fields="definedFields" />
                                        </fluro-panel-body>
                                    </fluro-panel>
                                </constrain>
                            </v-flex>
                            <v-flex xs12 sm4>
                                <fluro-panel>
                                    <fluro-panel-body>
                                        <h4>Run as an app</h4>
                                        <p>
                                            The Kiosk iOS and Android app allows you to run your checkin seamlessly on a tablet or phone device.
                                            You can download it from the Apple App Store or Google Play Marketplace by searching 'Fluro Kiosk'.
                                            Or by using one of the buttons below:
                                        </p>
                                        <v-layout>
                                            <v-flex>
                                                <v-btn color="primary" block href="https://apps.apple.com/au/app/fluro-kiosk/id1539557322">
                                                    Apple
                                                    <fluro-icon right icon="apple" library="fab" />
                                                </v-btn>
                                            </v-flex>
                                            <v-flex>
                                                <v-btn color="primary" block href="https://play.google.com/store/apps/details?id=io.fluro.apps.kiosk&hl=en_AU&gl=US">
                                                    Android
    ...
    computed: {
        ...
        fieldsOutput() {
            ...
            addField("requirePIN", {
                ...
                maximum: 1,
                type: "boolean",
                description: "Require a pin number to be entered to gain access to the checkin station when opening in browser. This is highly recommended to keep your checkin interface secure from being publicly accessible.",
                params: {
                    persistentDescription: true,
                }
            });
