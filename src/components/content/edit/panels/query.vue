                                ...
                                <tabset>
                                    ...
                                    <tab heading="Query" index="query" v-else>
                                        <flex-column style="min-height:600px;">
                                            <fluro-code-editor style="flex: 1 1 100%" v-model="model.query" lang="json" />
                                        </flex-column>
                                    </tab>
                                    <tab :heading="`${definition.title} Info`" v-if="definition && definition.fields && definition.fields.length">
                                        <fluro-panel-body>
