			...
			<fluro-panel-body>
				<v-container pa-0 grid-list-xl>
					<fluro-content-form-field
						...
						@input="update"
						:options="options"
						:field="fieldHash.accessKeyId"
						v-model="model.privateDetails.credentials"
					/>
					<fluro-content-form-field
						:form-fields="formFields"
						:outline="showOutline"
						@input="update"
						:options="options"
						:field="fieldHash.secretAccessKey"
						v-model="model.privateDetails.credentials"
					/>
					<fluro-content-form-field
						:form-fields="formFields"
						...
						@input="update"
						:options="options"
						:field="fieldHash.Bucket"
						v-model="model.privateDetails.params"
					/>
					<fluro-content-form-field
						:form-fields="formFields"
						:outline="showOutline"
						@input="update"
						:options="options"
						:field="fieldHash.transcodePipeline"
