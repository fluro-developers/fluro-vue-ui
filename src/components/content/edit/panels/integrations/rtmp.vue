                ...
                <tab heading="Testing">
                    <fluro-panel-body>
                        <v-container pa-0 grid-list-xl>
                            <fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.testHost" v-model="model.privateDetails" />
                            <fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.testStreamKey" v-model="model.privateDetails" />
                        </v-container>
                    </fluro-panel-body>
                </tab>
                <tab heading="Live">
                    <fluro-panel-body>
                        <v-container pa-0 grid-list-xl>
                            <fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.liveHost" v-model="model.privateDetails" />
                            <fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.liveStreamKey" v-model="model.privateDetails" />
                        </v-container>
                    </fluro-panel-body>
                </tab>
            </tabset>
