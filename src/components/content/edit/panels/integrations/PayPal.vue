																...
																<tab heading="Sandbox">
																				<fluro-panel-body>
																								<v-container pa-0 grid-list-xl>
																												<fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.sandboxAccount" v-model="model.privateDetails" />
																												<fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.sandboxClientID" v-model="model.privateDetails" />
																												<fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.sandboxClientSecret" v-model="model.privateDetails" />
																								</v-container>
																				</fluro-panel-body>
																</tab>
																<tab heading="Live">
																				<fluro-panel-body>
																								<v-container pa-0 grid-list-xl>
																												<fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.liveAccount" v-model="model.privateDetails" />
																												...
																												<fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.liveClientSecret" v-model="model.privateDetails" />
																								</v-container>
																				</fluro-panel-body>
																</tab>
												</tabset>
