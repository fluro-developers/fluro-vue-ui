			...
			<tabset>
				<tab heading="OAuth">
					<fluro-panel-body>
						<v-input
							class="no-flex"
							hint="Add this url as your Redirect URI in your Stripe Dashboard"
							label="OAuth Redirect URI"
						>
							<div
								v-tippy
								content="Click to copy to clipboard"
								@click.stop.prevent="$fluro.global.copyToClipBoard(redirectURI)"
							>
						...
						<v-input
							class="no-flex"
							hint="Direct users to this endpoint to authenticate their stripe accounts with this integration"
							label="OAuth Authentication"
						>
							<div
								v-tippy
								content="Click to copy to clipboard"
								@click.stop.prevent="$fluro.global.copyToClipBoard(authURL)"
							>
								<v-layout align-center>
				...
				<tab heading="Endpoints">
					<fluro-panel-body> </fluro-panel-body>
				</tab>
			</tabset>
		</fluro-panel>
		<fluro-panel v-else>
			<fluro-panel-body> Please save this integration to continue </fluro-panel-body>
		</fluro-panel>
	</div>
</template>
<script>
