          ...
          <flex-column-body style="background: #fafafa;">
            <v-container class="grid-list-xl">
              <constrain sm>
                ...
                <fluro-content-form-field
                  :override-label="definition && definition.definitionName && definition.definitionName == 'service' ? 'Service Time / Event Track' : 'Event Track'"
                  :form-fields="formFields"
                  :outline="showOutline"
                  @input="update"
                  :options="options"
            ...
            <constrain sm>
              <v-layout align-center>
                ...
                <v-flex shrink>
                  <v-btn
                    color="primary"
                    :to="{ name: 'events.multi', query: { ids: [model._id] } }"
                  >
                ...
                <fluro-panel-body>
                  <v-layout row wrap>
                    <v-flex
                      ...
                      md3
                      :key="index"
                      v-for="(slot, index) in roster.slots"
                      ...
                      <v-layout row wrap>
                        <v-flex xs12 sm6>
                          <v-input class="no-flex">
                            ...
                            <p
                              class="help-block"
                            >How many minutes earlier should the stream be available?</p>
                            <fluro-content-form-field
                              :form-fields="formFields"
                              @input="update"
                              :options="options"
                            ...
                            <p
                              class="lead"
                            >{{ streamStartDate | formatDate("h:mma dddd D MMM", model.timezone) }}</p>
                          </v-input>
                        </v-flex>
                        <v-flex xs12 sm6>
                          <v-input class="no-flex">
                            ...
                            <p
                              class="help-block"
                            >How many minutes after this event's end time should the stream be available?</p>
                            <fluro-content-form-field
                              :form-fields="formFields"
                              @input="update"
                              :options="options"
                            ...
                            <p
                              class="lead"
                            >{{ streamEndDate | formatDate("h:mma dddd D MMM", model.timezone) }}</p>
                          </v-input>
                        </v-flex>
                      </v-layout>
                    </v-container>
            ...
            <v-layout align-center>
              ...
              <v-flex shrink>
                <v-btn
                  color="primary"
                  @click="createPlan()"
                  v-if="$fluro.access.can('create', 'plan')"
                >
                  <span>Add Plan</span>
                    ...
                    <v-layout row wrap>
                      ...
                      <v-flex xs12 sm6>
                        <v-input class="no-flex">
                          ...
                          <p
                            class="help-block"
                          >How many minutes after this event's end time can a user still check in?</p>
                          <fluro-content-form-field
                            :form-fields="formFields"
                            @input="update"
                            :options="options"
  ...
  methods: {
    ...
    createPlan() {
      ...
      self.$fluro.global
        .select(
          "plan",
          { title: "Select a template", minimum: 1, maximum: 1 },
          true
        )
        .then(function(plans) {
  ...
  computed: {
    ...
    fieldsOutput() {
      ...
      addField("firstLine", {
        ...
        type: "string",
        placeholder:
          "Eg. A great event for the whole family. Featuring Special Guest...",
      ...
      addField("assets", {
        ...
        description:
          "Additional downloadable assets and resources for this event",
        minimum: 0,
        maximum: 0,
        type: "reference",
        directive: "reference-select",
      ...
      addField("socialBody", {
        ...
        description:
          "Add a social blurb and hashtags to use when sharing/promoting this event",
        minimum: 0,
        maximum: 1,
        type: "string",
        directive: "textarea"
      ...
      addField("forms", {
        ...
        description:
          "Manage registration forms that can be used to register for this event",
        minimum: 0,
        maximum: 0,
        type: "reference",
        directive: "reference-select",
    ...
    return {
      dateModel: {
        startDate: existingModel.startDate
          ? new Date(existingModel.startDate)
          : new Date(),
        endDate: existingModel.endDate
          ? new Date(existingModel.endDate)
          : new Date()
      }
    };
  }
