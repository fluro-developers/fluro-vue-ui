							...
							<v-container>
								<constrain sm>
									...
									<fluro-content-form-field
										...
										@input="update"
										:options="options"
										:field="fieldHash.mailoutType"
										v-model="model"
									/>
									<fluro-card v-if="mailoutType == 'promotional'">
										<fluro-card-body>
											<h6>Promotional Mode</h6>
											Default mailout type. Useful for promoting / letting people know of an
											event, service or product. Promotional emails will not send to selected
											contacts if they have unsubscribed.
										</fluro-card-body>
									</fluro-card>
									<fluro-card v-if="mailoutType == 'transactional'">
										<fluro-card-body>
											<h6>Transactional Mode</h6>
											It is entirely up to you to adhere to international email spam laws and to
											only send transactional mail as appropriate. Transactional emails will send
											to selected contacts even if they have previously unsubscribed from your
											emails.
										</fluro-card-body>
									</fluro-card>
								</constrain>
						...
						<flex-column-body style="background: #fafafa">
							<v-container class="mailout-recipients">
								<constrain sm>
									...
									<fluro-panel>
										<fluro-panel-title
											:class="{ collapsed: !expanded.contacts }"
											@click.native="toggleExpand('contacts')"
										>
									...
									<fluro-panel>
										<fluro-panel-title
											:class="{ collapsed: !expanded.teams }"
											@click.native="toggleExpand('teams')"
										>
											<v-layout align-center>
												<v-flex>
									...
									<fluro-panel>
										<fluro-panel-title
											:class="{ collapsed: !expanded.tickets }"
											@click.native="toggleExpand('tickets')"
										>
											<v-layout align-center>
												<v-flex>
									...
									<fluro-panel>
										<fluro-panel-title
											:class="{ collapsed: !expanded.events }"
											@click.native="toggleExpand('events')"
										>
											<v-layout align-center>
												<v-flex>
									...
									<fluro-panel>
										<fluro-panel-title
											:class="{ collapsed: !expanded.interactions }"
											@click.native="toggleExpand('interactions')"
										>
											<v-layout align-center>
												<v-flex>
									...
									<fluro-panel>
										<fluro-panel-title
											:class="{ collapsed: !expanded.checkins }"
											@click.native="toggleExpand('checkins')"
										>
											<v-layout align-center>
												<v-flex>
									...
									<fluro-panel>
										<fluro-panel-title
											:class="{ collapsed: !expanded.details }"
											@click.native="toggleExpand('details')"
										>
											<v-layout align-center>
												<v-flex>
									...
									<fluro-panel>
										<fluro-panel-title
											:class="{ collapsed: !expanded.families }"
											@click.native="toggleExpand('families')"
										>
											<v-layout align-center>
												<v-flex>
									...
									<fluro-panel>
										<fluro-panel-title
											:class="{ collapsed: !expanded.personas }"
											@click.native="toggleExpand('personas')"
										>
											<v-layout align-center>
												<v-flex>
									...
									<fluro-panel v-if="canSendTo('collection')">
										<fluro-panel-title
											:class="{ collapsed: !expanded.collections }"
											@click.native="toggleExpand('collections')"
										>
											<v-layout align-center>
												<v-flex>
													<h6>
														{{ verbiage(collections.length) }} Collections that contain
														contacts
													</h6>
												</v-flex>
												<v-flex shrink>
									...
									<fluro-panel>
										<fluro-panel-title
											:class="{ collapsed: !expanded.tags }"
											@click.native="toggleExpand('tags')"
										>
											<v-layout align-center>
												<v-flex>
									...
									<fluro-panel v-if="canSendTo('realm')">
										<fluro-panel-title
											:class="{ collapsed: !expanded.realms }"
											@click.native="toggleExpand('realms')"
										>
											<v-layout align-center>
												<v-flex>
										...
										<fluro-panel-body v-if="expanded.realms">
											...
											<fluro-content-form-field
												...
												@input="update"
												:options="options"
												:field="fieldHash.selectedRealms"
												v-model="model"
											/>
										</fluro-panel-body>
									</fluro-panel>
									<fluro-panel v-if="contactDefinitionOptions.length > 1">
										<fluro-panel-title
											:class="{ collapsed: !expanded.definitions }"
											@click.native="toggleExpand('definitions')"
										>
											<v-layout align-center>
												<v-flex>
													<h6>
														{{
															verbiage(
																model.definitionNames ? model.definitionNames.length : 0
															)
														}}
														Contact Definitions
													</h6>
										...
										<fluro-panel-body v-if="expanded.definitions">
											<fluro-content-form-field
												...
												@input="update"
												:options="options"
												:field="fieldHash.definitionNames"
												v-model="model"
											/>
										</fluro-panel-body>
									</fluro-panel>
									<fluro-panel v-if="canSendTo('process')">
										<fluro-panel-title
											:class="{ collapsed: !expanded.cards }"
											@click.native="toggleExpand('cards')"
										>
											<v-layout align-center>
												<v-flex>
									...
									<fluro-panel>
										<fluro-panel-title
											:class="{ collapsed: !expanded.query }"
											@click.native="toggleExpand('query')"
										>
											<v-layout align-center>
												<v-flex>
	...
	computed: {
		...
		expanded() {
			...
			return {
				...
				realms:
					self.expandedSettings._realms || (self.model.selectedRealms && self.model.selectedRealms.length),
				definitions:
					self.expandedSettings._definitions ||
					(self.model.definitionNames && self.model.definitionNames.length),
