        ...
        <tabset v-else :justified="true" :vertical="true">
            <tab heading="Details">
                    ...
                    <v-container>
                        <constrain sm>
                            ...
                            <div class="grid-list-xl">
                                ...
                                <fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.parent" v-model="model"></fluro-content-form-field>
                ...
                ></fluro-content-form-field> -->
                  ...
                  v-model="model"
                ></fluro-content-form-field> -->
                                <fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.integrations" v-model="model"></fluro-content-form-field>
                            </div>
                        </constrain>
                    </v-container>
                </flex-column-body>
                    ...
                    <v-container grid-list-xl>
                        <constrain sm>
                            <v-layout row>
                                ...
                                <v-flex grow sm9>
                                    <fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.measure" v-model="model"></fluro-content-form-field>
                                </v-flex>
                            </v-layout>
                            <!-- <pre>{{model}}</pre> -->
                ...
                <flex-column-body style="background: #fafafa;">
                    <v-container>
                        <constrain sm>
                            <!-- <pre>{{model}}</pre> -->
                            <div class="grid-list-xl">
                                <fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.sendContacts" v-model="model"></fluro-content-form-field>
                                <fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.sendTeams" v-model="model"></fluro-content-form-field>
                            </div>
                        </constrain>
                    </v-container>
                </flex-column-body>
