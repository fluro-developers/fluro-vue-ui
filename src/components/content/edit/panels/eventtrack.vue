          ...
          <v-container class="grid-list-xl">
            <constrain sm>
              ...
              <fluro-content-form-field
                ...
                @input="update"
                :options="options"
                :field="fieldHash.defaultFirstLine"
                v-model="model"
              />
              <br />
              <fluro-content-form-field
              ...
              <fluro-content-form-field
                ...
                @input="update"
                :options="options"
                :field="fieldHash.defaultExpectTeams"
                v-model="model"
              />
              <br />
              <fluro-content-form-field
        ...
        <flex-column-body style="background: #fafafa;">
          <v-container>
            <constrain md>
              ...
              <reminder-event-manager
                :config="config"
                v-model="model.defaultReminders"
                :allAssignmentOptions="allPositions"
              />
            </constrain>
          </v-container>
        </flex-column-body>
                ...
                <fluro-panel-body v-if="model.autoRecur">
                  <v-layout row wrap>
                    ...
                    <v-flex
                      xs12
                      sm4
                      v-if="(model.recurMeasure == 'months') && (model.recurNth == 'date')"
                    >
                      <fluro-content-form-field
                        :form-fields="formFields"
                        :outline="showOutline"
