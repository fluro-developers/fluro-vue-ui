											...
											<fluro-panel-body>
												...
												<template v-if="!model._id">
													<div v-show="showDefinitionName">
														<div
															v-show="!editDefinitionName && model.definitionName"
															v-tippy
															content="Edit database definition name"
															@click="editDefinitionName = true"
															class="font-xs muted"
														>
															<strong>Database name:</strong> {{ model.definitionName }}
														...
														<div v-show="editDefinitionName">
															<fluro-content-form-field
																...
																@input="update"
																:options="options"
																:field="fieldHash.definitionName"
																v-model="model"
															/>
														</div>
													</div>
												...
												<fluro-content-form-field
													...
													@input="update"
													:options="options"
													:field="fieldHash.privacy"
													v-model="model"
												/>
											</fluro-panel-body>
										</fluro-panel>
										<div v-if="legacyOptionsAreHidden">
											<a class="font-xs muted" @click="showLegacyOptions = !showLegacyOptions"
												>Show legacy form form options <fluro-icon icon="angle-down" right
											/></a>
										</div>
										<div v-else>
											<fluro-panel margin>
													...
													<fluro-content-form v-model="model.data" :fields="dataFields">
														...
														>
															...
															<fluro-content-form-field
																...
																@input="update"
																:options="options"
																:field="fieldHash.allowAnonymous"
																v-model="model"
															/>
															<template
																v-if="
																	!model.allowAnonymous && !model.disableDefaultFields
																"
															>
																<fluro-content-form-field
																	:form-fields="formFields"
											...
											<fluro-panel margin>
												...
												<fluro-content-form v-model="model.data" :fields="dataFields">
													<template
														v-slot:form="{ formFields, fieldHash, model, update, options }"
													>
																...
																<v-layout align-center>
																	...
																	<v-flex xs4>
																		<fluro-content-form-field
																			...
																			@input="update"
																			:options="options"
																			:field="fieldHash.requireFirstName"
																			v-model="model"
																		/>
																	</v-flex>
																</v-layout>
																...
																<v-layout align-center>
																	...
																	<v-flex xs4>
																		<fluro-content-form-field
																			...
																			@input="update"
																			:options="options"
																			:field="fieldHash.requireLastName"
																			v-model="model"
																		/>
																	</v-flex>
																</v-layout>
														...
														>
															<fluro-content-form-field
																...
																@input="update"
																:options="options"
																:field="fieldHash.disableBestGuess"
																v-model="model"
															/>
														</fluro-panel-body>
													</template>
														...
														<fluro-content-form v-model="model.data" :fields="dataFields">
															...
															>
																<fluro-content-form-field
																	...
																	@input="update"
																	:options="options"
																	:field="fieldHash.enableConfirmation"
																	v-model="model"
																/>
																<fluro-content-form-field
																	:form-fields="formFields"
																	@input="update"
																	:options="options"
																	:field="fieldHash.includeTickets"
																	v-model="model"
																/>
																<fluro-content-form-field
																	:form-fields="formFields"
																	@input="update"
																	:options="options"
																	:field="fieldHash.confirmationMessage"
																	v-model="model"
																/>
																<fluro-content-form-field
																	:form-fields="formFields"
																	@input="update"
																	:options="options"
																	:field="fieldHash.confirmationTemplate"
																	v-model="model"
																/>
																<fluro-content-form-field
																	:form-fields="formFields"
																	@input="update"
																	:options="options"
																	:field="fieldHash.notifyContacts"
																	v-model="model"
																/>
																<fluro-content-form-field
																	:form-fields="formFields"
																...
																<fluro-content-form-field
																	...
																	@input="update"
																	:options="options"
																	:field="fieldHash.notificationMessage"
																	v-model="model"
																/>
																<fluro-content-form-field
																	:form-fields="formFields"
														...
														<fluro-content-form v-model="model.data" :fields="dataFields">
															...
															>
																<fluro-content-form-field
																	...
																	@input="update"
																	:options="options"
																	:field="fieldHash.interactionProcesses"
																	v-model="model"
																/>
																<fluro-content-form-field
																	:form-fields="formFields"
																	@input="update"
																	:options="options"
																	:field="fieldHash.contactProcesses"
																	v-model="model"
																/>
																<fluro-content-form-field
																	:form-fields="formFields"
																	@input="update"
																	:options="options"
																	:field="fieldHash.contactProcessesAll"
																	v-model="model"
																/>
																<fluro-content-form-field
																	:form-fields="formFields"
																	@input="update"
																	:options="options"
																	:field="fieldHash.processAssignTo"
																	v-model="model"
																/>
															</template>
														</fluro-content-form>
														...
														<fluro-content-form v-model="model.data" :fields="dataFields">
															...
															>
																...
																<fluro-content-form-field
																	...
																	@input="update"
																	:options="options"
																	:field="fieldHash.contactTeamsAll"
																	v-model="model"
																/>
															</template>
														</fluro-content-form>
														...
														<fluro-content-form v-model="model.data" :fields="dataFields">
															...
															>
																<fluro-content-form-field
																	...
																	@input="update"
																	:options="options"
																	:field="fieldHash.contactCapabilities"
																	v-model="model"
																/>
																<fluro-content-form-field
																	:form-fields="formFields"
																	@input="update"
																	:options="options"
																	:field="fieldHash.capabilitiesAll"
																	v-model="model"
																/>
															</template>
														</fluro-content-form>
														...
														<fluro-content-form v-model="model.data" :fields="dataFields">
															...
															>
																<fluro-content-form-field
																	...
																	@input="update"
																	:options="options"
																	:field="fieldHash.reactionPipelines"
																	v-model="model"
																/>
															</template>
														</fluro-content-form>
										...
										<fluro-panel margin>
											<fluro-panel-title>
												...
												<div class="muted">
													...
													{{ model.parentType | definitionTitle(true) }} can be created in
												</div>
											</fluro-panel-title>
											<fluro-panel-body>
											...
											<fluro-panel margin>
												...
												<template v-if="paymentIsEnabled">
													<v-container pa-0>
														...
														<fluro-panel-body
															class="border-top"
															v-if="model.allow && !model.required"
														>
															<fluro-content-form-field
																:form-fields="formFields"
																@input="update"
									...
									<template v-if="paymentIsEnabled">
										<v-input class="no-flex">
											...
											<fluro-content-select-button
												block
												:lockFilter="paymentGatewayFilter"
												type="integration"
												v-model="model.data.publicData.paymentGateways"
											/>
											<!-- </fluro-panel-body> -->
										</v-input>
										<payment-gateway-expression-editor
											v-if="model.data.publicData.paymentGateways.length > 1"
											:form="model"
											v-model="model.data.gatewaySettings"
										/>
										<fluro-panel margin>
											<fluro-panel-body>
												<!-- <fluro-panel-title> -->
												...
												<p class="help-block">
													Add payment modifiers to adjust the required payment amount
													depending on values entered by the user
												</p>
												<!-- </fluro-panel-title> -->
												<!-- <v-input class="no-flex"> -->
												<payment-modifier-editor
													:form="model"
													v-model="model.paymentDetails.modifiers"
												/>
										...
										<fluro-content-form v-model="model.paymentDetails" :fields="paymentFields">
											<template v-slot:form="{ formFields, fieldHash, model, update, options }">
												<fluro-content-form-field
													...
													@input="update"
													:options="options"
													:field="fieldHash.allowAlternativePayments"
													v-model="model"
												/>
												<fluro-panel margin v-if="model.allowAlternativePayments">
													...
													<tabset>
														<tab
															...
															:key="method.guid"
															v-for="(method, index) in alternativePaymentMethods"
														>
															<fluro-panel-body>
																<fluro-content-form
																	v-model="alternativePaymentMethods[index]"
																...
																<v-layout>
																	...
																	<v-flex shrink>
																		<v-btn
																			...
																			color="error"
																			@click="
																				removeAlternativePaymentMethod(
																					method,
																					index
																				)
																			"
													...
													<fluro-panel-body class="border-top">
														...
														<v-btn
															class="ma-0"
															@click="addAlternativePaymentMethod()"
															color="primary"
															>Add additional payment method</v-btn
														>
													</fluro-panel-body>
												</fluro-panel>
											</template>
								...
								<constrain sm>
									<fluro-panel>
										<fluro-panel-body>
											...
											<template v-else>
												...
												<template v-if="lockedSubType"> </template>
												<template v-else>
													<fluro-content-form-field
														:form-fields="formFields"
														:outline="showOutline"
															...
															<v-layout>
																...
																<v-flex xs12 sm6>
																	<div class="form-group">
																		<label>Extends type</label>
																		<div>
																			{{ model.parentType | definitionTitle }}
																		</div>
																	</div>
																</v-flex>
															</v-layout>
									...
									<fluro-panel v-if="model.parentType == 'event'">
										<fluro-panel-body>
											...
											<event-message-manager
												type="definition"
												v-model="model.data.defaultMessages"
											/>
											<!-- <fluro-content-form-field :form-fields="formFields" :outline="showOutline" @input="update" :options="options" :field="fieldHash.firstLine" v-model="model" /> -->
									...
									<fluro-panel v-if="model.parentType == 'team'">
										<fluro-panel-body>
											...
											<group-role-manager
												:definitionMode="true"
												v-model="model.data.defaultPositions"
											/>
										</fluro-panel-body>
									</fluro-panel>
										...
										<tabset justified>
											...
											<tab heading="Reminders">
												<fluro-panel-body>
													...
													<definition-reminder-manager
														:slots="model.data.slots"
														v-model="model.data.defaultReminders"
													/>
												</fluro-panel-body>
											</tab>
...
<fluro-code-editor style="flex: 1 1 100%" v-model="model.data.js" lang="javascript" />
							...
							<flex-column class="code-panel" :class="{ 'panel-collapsed': collapsed.html }">
								<div class="code-heading" @click="togglePanel('html')">
									<v-layout>
										<v-flex>
											<label>
												<fluro-icon icon="caret-right" library="fas" left /><strong
													>HTML (EJS)</strong
												>
											</label>
										</v-flex>
							...
							<flex-column class="code-panel light" :class="{ 'panel-collapsed': collapsed.preview }">
								<div class="code-heading" @click="togglePanel('preview')">
									<v-layout>
										...
										<v-flex
											...
											content="Expand"
											class="arrow-expander"
											@click.stop.prevent="togglePanel('preview', true)"
										>
											<fluro-icon icon="expand-alt" />
										</v-flex>
									</v-layout>
								...
								<flex-column class="code-panel-column">
									...
									<mailout-render-preview
										:live="true"
										:cacheKey="mailoutCacheKey"
										:definition="model.definitionName"
									/>
								...
								<div class="code-heading" @click="togglePanel('tokens')">
									<v-layout>
										...
										<v-flex
											...
											content="Expand"
											class="arrow-expander"
											@click.stop.prevent="togglePanel('tokens', true)"
										>
											<fluro-icon icon="expand-alt" />
										</v-flex>
									</v-layout>
												...
												<fluro-accordion-panel heading="Help / Utilities">
													<v-container fluid>
														...
														<v-input class="no-flex">
															...
															<p class="help-block">
																Generated by providing a path to the image on the
																mailout data
															</p>
															<div class="help-snippet">
																<%= imageUrl('path.to.image', optionalWidth,
																optionalHeight, options) %>
															</div>
														</v-input>
														<v-input class="no-flex">
															<v-label>Image URL</v-label>
															...
															<div class="help-snippet">
																<%= imageUrl('5c872b1f2380ba45e486b033', 500, null,
																{static:true}) %>
															</div>
														</v-input>
														<v-input class="no-flex">
															...
															<div class="help-snippet">
																<%= posterUrl('path.to.video', optionalWidth,
																optionalHeight) %>
															</div>
														</v-input>
														<v-input class="no-flex">
														...
														<v-input class="no-flex">
															...
															<div class="help-snippet"><%- pre('path.to.data') %></div>
														</v-input>
														<v-input class="no-flex">
															<v-label>Escape HTML</v-label>
															<div class="help-snippet"><%- get('path.to.data') %></div>
														</v-input>
														<v-input class="no-flex">
														...
														<v-input class="no-flex">
															...
															<div class="help-snippet"><%- tracker %></div>
														</v-input>
													</v-container>
												</fluro-accordion-panel>
											</fluro-accordion>
...
export default {
	...
	computed: {
		...
		paymentMethodFields() {
			return [
				...
				},
				{
					...
					directive: 'wysiwyg',
					description:
						'Write a summary of how you want people to pay you if they are using alternative methods',
		...
		dataFields() {
			...
			var contactProcessesTitle = self.model.data.contactProcessesAll
				? 'Add all connected contacts to processes'
				: 'Add primary contact to processes';
			...
			var contactTeamsAllTitle = self.model.data.contactTeamsAll
				? 'Add all connected contacts to groups/teams'
				: 'Add primary contact to groups/teams';
			...
			var capabilitiesAllTitle = self.model.data.capabilitiesAll
				? 'Add capabilities to all connected contacts'
				: 'Add capabilities to primary contact';
...
Sometimes it makes more sense to ask/require one or both of these`,
		...
		postFields() {
			...
			array.push({
				...
				description: `Send a basic notification to the selected contacts each time a new ${
					self.model.title || 'post'
				} is submitted`,
			});
		...
		fieldsOutput() {
			...
			addField('firstLine', {
				...
				description: `Write a short description about what these ${self.$fluro.types.readable(
