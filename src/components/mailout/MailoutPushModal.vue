                    ...
                    <flex-column-footer class="border-top">
                        <v-container px-0 py-2>
                            <v-layout>
                                ...
                                <v-spacer />
                                <v-btn :loading="sending" color="primary" :disabled="invalid" @click="sendTo('contact')">
                                    Push
                    ...
                    <flex-column-footer class="border-top">
                        <v-container px-0 py-2>
                            <v-layout>
                                ...
                                <v-spacer />
                                <v-btn :loading="sending" color="primary" :disabled="!model.contacts.length" @click="sendTo('contacts')">
                    ...
                    <flex-column-footer class="border-top">
                        <v-container px-0 py-2>
                            <v-layout>
                                ...
                                <v-spacer />
                                <v-btn :loading="sending" color="primary" :disabled="!model.personas.length" @click="sendTo('personas')">
...
export default {
    ...
    methods: {
        sendTo(type) {
            ...
            self.sending = true;
            self.$fluro.api.post(`/mailout/${self.item._id}/push`, self.model)
                .then(function(res) {
                    self.sending = false;
