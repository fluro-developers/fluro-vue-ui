...
export default {
				...
				beforeCreate() {
								...
								DynamicImportService.load('src/components/form/FluroContentForm.vue', function() {
												...
												.then(function(component) {
																self.$options.components.FluroContentForm = component;
																self.ready = true;
												});
								...
								// var alreadyImported = DynamicImportService['src/components/form/FluroContentForm.vue'];
								// if (!alreadyImported) {
								// 				alreadyImported = DynamicImportService['src/components/form/FluroContentForm.vue'] = import('src/components/form/FluroContentForm.vue');
								// }
								// alreadyImported.then(function(module) {
								// 				self.$options.components.FluroContentForm = module.default;
								// 				self.ready = true;
								// })
				...
				methods: {
								...
								valueChange(event, setTouched) {
												...
												// console.log('INPUT FROM', self.field.title, self.field.key);
