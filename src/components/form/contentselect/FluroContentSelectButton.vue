...
export default {
  ...
  computed: {
    ...
    canCreate() {
      var self = this;
      return (
        !self.createDisabled && self.$fluro.access.can("create", this.type)
      );
    },
    selection() {
  ...
  methods: {
    create() {
      ...
      self.$fluro.global
        .create(self.type, { disableCacheClearOnSave: true }, true)
        .then(function(res) {
