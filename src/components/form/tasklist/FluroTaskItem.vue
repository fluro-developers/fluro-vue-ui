												...
												<v-flex>
																...
																<div class="wrap">
																				<fluro-inline-edit>
																								...
																								<template v-slot:edit="{props, blur, focus}">
																												<textarea class="input" @focus="focus($event)" placeholder="Add more details to this task" @input="update" v-model="model.description" @keyup.enter="blur" @blur="blur"></textarea>
																								</template>
																				</fluro-inline-edit>
																</div>
												</v-flex>
