...
import AddPostModal from '../../ui/modal/AddPost.vue';
import FluroOptionsDialog from '../../ui/modal/OptionsDialog.vue';
...
export default {
	...
	computed: {
		...
		completeLabel() {
			return this.instructions.completeLabel && this.instructions.completeLabel.length
				? this.instructions.completeLabel
				: 'Complete';
		},
		pendingLabel() {
			return this.instructions.pendingLabel && this.instructions.pendingLabel.length
		...
		completeDescription() {
			return this.instructions.completeDescription && this.instructions.completeDescription.length
				? this.instructions.completeDescription
				: '';
		},
		pendingDescription() {
			return this.instructions.pendingDescription && this.instructions.pendingDescription.length
				? this.instructions.pendingDescription
				: '';
		},
		failedDescription() {
			return this.instructions.failedDescription && this.instructions.failedDescription.length
