<template>
	<li class="field-editor-item" :class="classes">
		...
		<div
			class="field-editor-item-field"
			@click="select(model)"
			@mouseover="mouseover(model)"
		...
		>
			...
			<v-layout align-center>
				...
				<fluro-help
					absolute
					uid="field.editor.item.drag"
					title="Drag to reorder"
					body="Click and drag to move or reorder fields within your form"
				/>
				...
				<v-flex shrink v-if="ticketed">
					<fluro-help
						absolute
						uid="field.editor.item.ticket"
						title="Ticketed Contact"
						body="Contacts created here have ticketing enabled. This means that tickets will be created upon submission of this form"
					/>
				...
				<v-flex shrink v-if="hasExpressions">
					<fluro-help
						absolute
						uid="field.editor.item.expressions"
						title="Expressions"
						body="This field has advanced logic and expressions that change how this field is displayed and behaves based on the input of the user"
					/>
				...
				<v-flex shrink v-if="officeUseOnly">
					<fluro-help
						absolute
						uid="field.editor.item.officeuse"
						title="Office Use Only"
						body="This field is only visible for administrators"
					/>
				...
				<v-flex shrink @click.stop.prevent>
					...
					<fluro-help
						absolute
						uid="field.editor.item.actions"
						title="More Options"
						body="More options for this field. Including deleting, duplicating and other useful actions."
					/>
				</v-flex>
			</v-layout>
		</div>
		...
		<template v-if="hasSubFields">
			...
			>
				...
				<fluro-field-editor-item
					...
					:selected="selected"
					:parent="model"
					:parentGroup="actualParentGroup"
					:leaf="model.fields[index]"
					:select="select"
					:mouseover="mouseover"
					...
					@copypath="copypath"
					@deleted="deleted"
					v-for="(leaf, index) in model.fields"
					:key="leaf.guid"
				/>
			</draggable>
		</template>
