  ...
  <flex-column class="fluro-field-editor" :class="{'schema-mode':!formMode}">
    <flex-row>
      <flex-column class="sidebar">
        <flex-column
          class="fields-tree"
          v-show="true || !(field || configurePayment || configureDefaults)"
        >
          <flex-column-header>
                  ...
                  <v-card tile>
                    <v-list dense>
                      ...
                      <v-list-tile @click="toggleDataModel()">
                        <v-list-tile-content>
                          <v-list-tile-title>{{dataModelEnabled ? 'Hide' : 'Show'}} Data Model</v-list-tile-title>
                        </v-list-tile-content>
                      </v-list-tile>
                    </v-list>
                  </v-card>
...
export default {
  ...
  computed: {
    ...
    formMode() {
      return (
        this.item.definition == "form" || this.item.parentType == "interaction"
      );
    },
    showPreview() {
      // if(!this.formMode) {
  ...
  methods: {
    ...
    deleteSelectedField() {
      ...
      self.$fluro
        .confirm(
          `Delete Field`,
          `Are you sure you want to delete '${selectedField.title}'?`,
          {
            confirmColor: "error",
    ...
    addNewField(type, newField) {
      ...
      if (
        newField.directive == "embedded" &&
        self.field.directive == "embedded"
      ) {
