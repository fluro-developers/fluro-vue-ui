      ...
      <tab heading="Expressions">
        <flex-column-body>
          <v-container class="border-bottom" style="background: #fff;">
            ...
            <div
              class="sm muted"
            >Expressions are short pieces of javascript that can be used to alter the properties of this field depending on changes made in other fields</div>
            <v-btn
              class="ml-0"
              small
              ...
              <fluro-panel-body class="border-top">
                <v-layout>
                  ...
                  <v-flex
                    xs9
                    class="sm muted"
                  >The immediate model this field is attached to. Useful for relative paths to sibling fields</v-flex>
                </v-layout>
              </fluro-panel-body>
              <fluro-panel-body class="border-top">
                <v-layout>
                  ...
                  <v-flex
                    xs9
                    class="sm muted"
                  >The root level model for the entire form, useful for absolute paths to other fields.</v-flex>
                </v-layout>
              </fluro-panel-body>
            </fluro-panel>
            ...
            <template v-else>
              <template v-if="requiresOptions">
                <template v-if="!advancedOptions">
                  ...
                  >Show advanced labelling options</div>
                </template>
                <template v-else>
...
export default {
  ...
  methods: {
    ...
    selectTitle(select) {
      ...
      if (select) {
        setTimeout(function() {
          var match =
            self.model.type == "group"
              ? self.$refs.grouptitle
              : self.$refs.title;
  ...
  computed: {
    ...
    ticketingManager() {
      if (
        this.model.type == "reference" &&
        this.restrictType == "contact" &&
    ...
    fields() {
      ...
      var definitionTitle = self.$fluro.types.readable(
        self.restrictType || "node",
        true
      );
      ...
      addField("officeUseOnly", {
        ...
        description:
          "Check this if you want this field to be excluded from public facing webforms",
        minimum: 0,
        maximum: 1,
        type: "boolean"
      });
      ...
      addField("groupMinimum", {
        ...
        key: "minimum",
        description:
          "Minimum amount of entries for this group that can be created",
        minimum: 0,
        maximum: 1,
        type: "integer",
        params: {
      ...
      addField("groupMaximum", {
        ...
        key: "maximum",
        description:
          "Maximum amount of entries for this group that can be created",
        minimum: 0,
        maximum: 1,
        type: "integer",
        params: {
      ...
      addField("key", {
        ...
        expressions: {
          ...
          defaultValue() {
            var regexp = /[^a-zA-Z0-9-_]+/g;
            var cleaned = _.camelCase(
              String(self.model.title).replace(regexp, "")
            );
      ...
      addField("description", {
        ...
        description:
          "An optional description that can add extra detail for users entering data",
        minimum: 0,
        maximum: 1,
        type: "string"
      });
      ...
      addField("type", {
        title: "Data Type",
        description:
          "The required kind of input that can be entered into this field",
        minimum: 1,
        maximum: 1,
        type: "string",
        directive: "select",
      ...
      addField("referenceType", {
        ...
        description:
          "Restrict what kind of items can be referenced in this field",
        minimum: 0,
        maximum: 1,
        type: "string",
        directive: "select",
      ...
      addField("storeData", {
        ...
        description:
          "Write the terms the user is agreeing to when ticking this field",
        minimum: 0,
        maximum: 1,
        type: "string",
        directive: "textarea",
      ...
      addField("directive", {
        title: "Input Type",
        description:
          "What kind of widget should be provided to the user for input?",
        minimum: 1,
        maximum: 1,
        type: "string",
        directive: "select",
      ...
      addField("sameLine", {
        title: "Same Line",
        description:
          "Attempt to render fields in this group on the same line on larger screens",
        minimum: 0,
        maximum: 1,
        type: "boolean"
      });
