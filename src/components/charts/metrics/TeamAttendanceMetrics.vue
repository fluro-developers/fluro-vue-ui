...
export default {
    ...
    computed: {
        ...
        checkedIn() {
            ...
            return _.map(this.selectedEvent.checkins, function(checkin) {
                ...
                return Object.assign(checkin, { _type: 'contact', _id: self.$fluro.utils.getStringID(checkin.contact), checkin: true });
            })
        },
        allMembers() {
        ...
        membersLookup() {
            return _.reduce(this.allMembers, function(set, member) {
        ...
        leaders() {
            var self = this;
            return _.chain(self.group.assignments)
                .map('contacts')
                .flatten()
                .value();
        },
        ...
        model: {
            get() {
                ...
                return new Promise(function(resolve, reject) {
                    ...
                    switch (self.type) {
                        case 'team':
                            self.$fluro.api.get(`/chart/groups/${id}/simple`, {
                                params: {
                                    startDate,
                                    endDate,
                                }
    ...
    methods: {
        ...
        editPost(post) {
            self.$fluro.global.edit(post, true)
