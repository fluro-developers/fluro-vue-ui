				...
				<fluro-panel-body>
					<div class="field-group">
						...
						<div class="muted font-sm">
							<span v-if="model.stats.headcount">{{ model.stats.headcount }} Headcount.&nbsp;</span
							><span v-if="model.stats.checkin">{{ model.stats.checkin }} Checked in</span>
						</div>
					</div>
				</fluro-panel-body>
			</fluro-panel>
				...
				<v-flex shrink>
					<fluro-panel class="gender">
						...
						<fluro-panel-body>
							...
							<template v-else>
								<div class="muted">Gender demographics are not available for this event.</div>
							</template>
						</fluro-panel-body>
					</fluro-panel>
				</v-flex>
				<v-flex>
					<fluro-panel class="ages">
						...
						<fluro-panel-body>
							...
							<template v-else>
								<div class="muted">Age demographics are not available for this event.</div>
							</template>
						</fluro-panel-body>
					</fluro-panel>
				</v-flex>
		...
		model: {
			...
			get() {
				...
				return new Promise(function (resolve, reject) {
					...
					self.$fluro.api.get(endpoint, {}).then(
						function (res) {
							resolve(res.data);
