...
var script$2 = {
  mixins: [FluroContentEditMixin.FluroContentEditMixin],
  components: {
    FilterConditionGroup: index.FilterConditionGroup,
  ...
  computed: {
    ...
    changeString() {
      ...
      var filterString = fluro.FilterService.getFilterChangeString(self.model.filterConfiguration);
...
//# sourceMappingURL=query-a2419413.js.map
