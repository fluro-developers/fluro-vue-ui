...
var script$2 = {
  ...
  computed: {
    locationOptions() {
      var self = this;
      return index._.chain(self.locations).map(function (loc) {
        var locationName = loc.title;

        index._.forEach(loc.rooms, function (room) {
    ...
    roomOptions() {
      ...
      var temp = index._.chain(self.model[self.locationsPath]).map(function (loc) {
        if (loc.rooms.length && !loc.rooms[0].locationName) {
          index._.forEach(loc.rooms, self.findLocationName);
        }
...
exports.LocationSelector = __vue_component__$2;
exports.MessagingEventManager = __vue_component__$1;
//# sourceMappingURL=LocationSelector-34fec6ae.js.map
