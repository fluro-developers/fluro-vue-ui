...
require('fluro');
var vuexMapFields = require('vuex-map-fields');
require('async');
...
var script = {
  ...
  components: {
    ...
    FluroTaskList: index.FluroTaskList // FluroAvatarUpdate,
    // FluroContentForm,
    // FluroRealmSelect,
  ...
  computed: index._objectSpread2({}, vuexMapFields.mapFields('fluro', ['application', //The Fluro application and all of it's permissions and data
...
//# sourceMappingURL=process-3e03055c.js.map
