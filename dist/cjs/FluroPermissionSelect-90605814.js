...
var __vue_staticRenderFns__ = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('thead',[_c('tr',[_c('th',{staticClass:"column"},[_vm._v("Role")]),_vm._v(" "),_c('th',{staticClass:"column"},[_vm._v("Realms")]),_vm._v(" "),_c('th',[_vm._v(" ")])])])}];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-21ae5a14_0", { source: ".border-top[data-v-21ae5a14]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-21ae5a14]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-21ae5a14]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-21ae5a14]{border-left:1px solid rgba(0,0,0,.05)}.table[data-v-21ae5a14]{background:#fff;width:100%;border-collapse:collapse;padding:0;margin:0;border:1px solid rgba(0,0,0,.1);box-shadow:0 1px 1px rgba(0,0,0,.1);margin-bottom:25px}.table thead[data-v-21ae5a14]{text-transform:uppercase;letter-spacing:.03em;font-weight:500;font-size:12px}.table td[data-v-21ae5a14],.table th[data-v-21ae5a14]{padding:10px;text-align:left;border-bottom:1px solid rgba(0,0,0,.1);vertical-align:middle}.table td.column[data-v-21ae5a14],.table th.column[data-v-21ae5a14]{width:50%}.table th[data-v-21ae5a14]{background:rgba(0,0,0,.05)}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-21ae5a14";
  /* module identifier */
...
exports.FluroPermissionSelect = __vue_component__;
//# sourceMappingURL=FluroPermissionSelect-90605814.js.map
