...
var FluroPermissionSelect = require('./FluroPermissionSelect-90605814.js');
...
var script = {
  ...
  components: {
    FluroRealmDots: index.FluroRealmDots,
    FluroContentSelectButton: index.FluroContentSelectButton
  },
  mixins: [index.FluroSelectionMixin],
  props: {
    'host': {
      type: Object
    },
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-4e3ba3f1_0", { source: ".border-top[data-v-4e3ba3f1]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-4e3ba3f1]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-4e3ba3f1]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-4e3ba3f1]{border-left:1px solid rgba(0,0,0,.05)}.access-pass-select[data-v-4e3ba3f1] .list-group-item-content{padding-left:10px}.access-pass-select .flip-list-move[data-v-4e3ba3f1]{transition:transform .5s}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-4e3ba3f1";
  /* module identifier */
...
var script$1 = {
  ...
  components: {
    ...
    FluroPermissionSelect: FluroPermissionSelect.FluroPermissionSelect,
    FluroAvatarUpdate: index.FluroAvatarUpdate,
    FluroRealmSelect: index.FluroRealmSelect
  },
  methods: {
    modelUpdated() {
...
var __vue_staticRenderFns__$1 = [];
  ...
  const __vue_inject_styles__$1 = function (inject) {
    if (!inject) return
    inject("data-v-067bcbea_0", { source: ".border-top[data-v-067bcbea]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-067bcbea]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-067bcbea]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-067bcbea]{border-left:1px solid rgba(0,0,0,.05)}.hint[data-v-067bcbea]{font-size:10px;opacity:.5;color:inherit;display:block}.bordered[data-v-067bcbea]{border:1px solid rgba(0,0,0,.1);box-shadow:0 2px 4px rgba(0,0,0,.1)}.bordered[data-v-067bcbea] .tabset-menu{background:#eee}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$1 = "data-v-067bcbea";
  /* module identifier */
...
//# sourceMappingURL=persona-334b61cd.js.map
