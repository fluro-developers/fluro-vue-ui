...
var script$1 = {
  ...
  components: {
    ListGroup: index.ListGroup,
    ListGroupItem: index.ListGroupItem,
...
var script$2 = {
  ...
  methods: {
    ...
    select(type) {
      ...
      var SelectionManager = index.Vue.extend(index.FluroSelector);
      var instance = new SelectionManager({
        propsData: {
          minimum: 0,
          maximum: 0
      ...
      var promise = self.$fluro.modal({
        component: index.FluroContentSelectModal,
        options: {
  ...
  components: {
    ...
    FluroContentSelectModal: index.FluroContentSelectModal
  },
  computed: {
    capabilityGroups() {
      var self = this; ////////////////////////////////////////////////////
...
var script$3 = {
  ...
  components: {
    ...
    // FluroAvatarStack,
    ListGroup: index.ListGroup,
    ListGroupItem: index.ListGroupItem // FluroContentSelectButton,
...
var script$4 = {
  ...
  components: {
    ...
    ListGroup: index.ListGroup,
    ListGroupItem: index.ListGroupItem,
    FluroConfirmButton: index.FluroConfirmButton // FluroContentSelectButton,
    // FluroContentSelectModal,
...
var __vue_staticRenderFns__$4 = [];
  ...
  const __vue_component__$4 = index.__vue_normalize__(
...
var script$5 = {
  ...
  //     }
  // },
  mixins: [FluroContentEditMixin.FluroContentEditMixin, index.FluroContactCommunicateMixin],
  components: {
    ContactTimeline: index.ContactTimeline,
    ContactMessageList: index.ContactMessageList,
    ContactTransactionList: index.ContactTransactionList,
    ContactInteractionList: index.ContactInteractionList,
    ContactCheckinList: index.ContactCheckinList,
    ContactPostThread: index.ContactPostThread,
    ContactGroupManager: index.ContactGroupManager,
    ...
    FluroAcademicSelect: index.FluroAcademicSelect
  },
  methods: {
    ping(device) {
      var self = this;
...
var __vue_staticRenderFns__$5 = [];
  ...
  const __vue_component__$5 = index.__vue_normalize__(
...
//# sourceMappingURL=contact-285fed5e.js.map
