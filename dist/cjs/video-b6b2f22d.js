...
var FluroAssetEditMixin = require('./FluroAssetEditMixin-db9436fd.js');
...
var script = {
  components: {
    ...
    FluroCodeEditor: index.FluroCodeEditor
  },
  ...
  mixins: [FluroContentEditMixin.FluroContentEditMixin, FluroAssetEditMixin.FluroAssetEditMixin],
  computed: {
    showVideo() {
      var self = this;
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-3e605312_0", { source: ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}.media-preview{background:#eee;display:block;min-height:350px;margin-bottom:15px;border:1px solid rgba(0,0,0,.1);border-radius:5px;overflow:hidden}.media-preview .media-preview-wrap{max-width:750px;margin:auto}", map: undefined, media: undefined })
,inject("data-v-3e605312_1", { source: ".border-top[data-v-3e605312]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-3e605312]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-3e605312]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-3e605312]{border-left:1px solid rgba(0,0,0,.05)}.color-swatch[data-v-3e605312]{width:36px;height:36px;border-radius:3px;margin:0 1px 1px 0;display:inline-block}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-3e605312";
  /* module identifier */
...
//# sourceMappingURL=video-b6b2f22d.js.map
