...
var AddressManager = require('./AddressManager-1b71e31e.js');
...
var script = {
  ...
  components: {
    FluroContentForm: index.FluroContentForm,
    FluroContentFormField: index.FluroContentFormField,
    FluroStatusSelect: index.FluroStatusSelect,
    FluroAvatar: index.FluroAvatar
  },
  ...
  computed: {
    ...
    fieldsOutput() {
      ...
      contactFields.push({
        ...
        maximum: 1,
        type: 'string',
        customComponent: index.FluroAcademicSelect,
        expressions: {
    ...
    contactDefinitions: {
      ...
      get() {
        ...
        return new Promise(function (resolve, reject) {
          return self.$fluro.types.subTypes('contact').catch(reject).then(resolve);
        }).catch(function (err) {
          console.log(err);
...
//# sourceMappingURL=family-e1a27c8c.js.map
