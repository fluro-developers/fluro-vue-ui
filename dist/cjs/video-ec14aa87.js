...
var FluroDefinedList = require('./FluroDefinedList-7f6e1d28.js');
...
var script = {
  ...
  components: {
    FluroDefinedList: FluroDefinedList.FluroDefinedList
  },
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-931ec9fa_0", { source: ".border-top[data-v-931ec9fa]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-931ec9fa]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-931ec9fa]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-931ec9fa]{border-left:1px solid rgba(0,0,0,.05)}", map: undefined, media: undefined });
...
//# sourceMappingURL=video-ec14aa87.js.map
