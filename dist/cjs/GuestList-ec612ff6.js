...
var script = {
  ...
  computed: {
    floatPositions() {
      var self = this;
      return index._.chain(self.positions).filter(function (pos) {
  ...
  methods: {
    ...
    initMarkers() {
      ...
      self.markers = index._.map(self.floatPositions, function (pos) {
    ...
    createContentString(obj) {
      ...
      if (obj._type == "family") {
        text += "<h5>" + index._.startCase(obj.title) + " Household</h5>";
        item = obj.address;
      } else {
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-14eb968c_0", { source: ".google-map[data-v-14eb968c]{width:100%;height:100%;background:gray}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-14eb968c";
  /* module identifier */
...
var script$1 = {
  components: {
    SearchInput: index.SearchInput,
    AvatarCell: index.AvatarCell,
    FluroTable: index.FluroTable
  },
  props: {
    event: {
      type: [Object, String]
...
var __vue_staticRenderFns__$1 = [];
  ...
  const __vue_inject_styles__$1 = function (inject) {
    if (!inject) return
    inject("data-v-5d1e20a9_0", { source: ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}", map: undefined, media: undefined });
...
exports.GuestList = __vue_component__$1;
exports.LocationViewMapComponent = __vue_component__;
//# sourceMappingURL=GuestList-ec612ff6.js.map
