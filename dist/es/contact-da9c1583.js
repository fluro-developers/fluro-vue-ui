import { bf as _, bd as __vue_normalize__, be as __vue_create_injector__, b2 as ListGroup, b3 as ListGroupItem, ay as FluroSelector, aA as FluroContentSelectModal, aJ as FluroContentFormField, aB as FluroContentSelectButton, n as FluroConfirmButton, bb as FluroContactCommunicateMixin, U as ContactTimeline, X as ContactMessageList, Y as ContactTransactionList, Z as ContactInteractionList, $ as ContactCheckinList, V as ContactPostThread, bg as ContactGroupManager, d as FluroAvatarUpdate, aC as FluroRealmSelect, aM as FluroAcademicSelect } from './index-6dde7e0b.js';
import Vue from 'vue';
import 'vuedraggable';
import 'vue-color';
...
import { F as FluroContentEditMixin } from './FluroContentEditMixin-e904f109.js';
...
var __vue_staticRenderFns__$5 = [];
  ...
  const __vue_inject_styles__$5 = function (inject) {
    if (!inject) return
    inject("data-v-0a225760_0", { source: ".border-top[data-v-0a225760]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-0a225760]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-0a225760]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-0a225760]{border-left:1px solid rgba(0,0,0,.05)}.hint[data-v-0a225760]{font-size:10px;opacity:.5;color:inherit;display:block}.bordered[data-v-0a225760]{border:1px solid rgba(0,0,0,.1);box-shadow:0 2px 4px rgba(0,0,0,.1)}.bordered[data-v-0a225760] .tabset-menu{background:#eee}", map: undefined, media: undefined });
...
//# sourceMappingURL=contact-da9c1583.js.map
