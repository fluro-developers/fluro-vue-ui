import { ae as FluroContentView, bh as _, bf as __vue_normalize__, bg as __vue_create_injector__ } from './index-af7d480b.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
import { F as FluroContentEditMixin } from './FluroContentEditMixin-ec3937f5.js';
import { T as TicketTypeManager, M as MessagingEventManager, L as LocationSelector } from './TicketTypeManager-0565e8c5.js';
import { G as GuestList, L as LocationViewMapComponent } from './GuestList-c19c1d20.js';
import { T as TicketList } from './TicketList-06baa2cb.js';
import 'fluro-vue-ui';
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-aa7410b2_0", { source: ".border-top[data-v-aa7410b2]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-aa7410b2]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-aa7410b2]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-aa7410b2]{border-left:1px solid rgba(0,0,0,.05)}.event-cover-image[data-v-aa7410b2]{border-radius:5px;width:90%;padding-bottom:70%;background-repeat:no-repeat;background-position:center;background-size:cover;display:block;margin:5%}.hint[data-v-aa7410b2]{font-size:10px;opacity:.5;color:inherit;display:block}.copystring[data-v-aa7410b2]{width:100%;overflow:auto;display:block;background:#eee;border-radius:3px;opacity:.5;padding:10px;line-height:20px}.copystring[data-v-aa7410b2]:hover{opacity:1}.assignment-item[data-v-aa7410b2]{font-size:12px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;border-radius:100px;margin-bottom:2px;padding:2px 10px;font-weight:500;background-color:rgba(0,0,0,.05)}.assignment-item.confirmed[data-v-aa7410b2]{color:#4cc650;background-color:rgba(76,198,80,.05)}.assignment-item.denied[data-v-aa7410b2]{color:#d93e63;background-color:rgba(217,62,99,.05)}.assignment-item.unknown[data-v-aa7410b2]{color:#555}.assignment-item.proposed[data-v-aa7410b2]{background-color:rgba(42,212,185,.1);color:#197f6f}.btn-ghost[data-v-aa7410b2]{border:1px dashed #555;color:#555;opacity:.5}.btn-ghost[data-v-aa7410b2]:hover{opacity:1}.bordered[data-v-aa7410b2]{border:1px solid rgba(0,0,0,.1);box-shadow:0 2px 4px rgba(0,0,0,.1)}.bordered[data-v-aa7410b2] .tabset-menu{background:#eee}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-aa7410b2";
  /* module identifier */
...
//# sourceMappingURL=event-d52bbd2d.js.map
