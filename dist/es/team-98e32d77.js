...
import { r as FluroConfirmButton, bm as __vue_normalize__, bn as __vue_create_injector__, bo as _$1, aN as FluroContentForm, aO as FluroContentFormField } from './index-0ee71dc7.js';
...
import { F as FluroExclusiveSelector } from './FluroExclusiveSelector-6162a2bc.js';
  ...
  computed: {
    eventData() {
      ...
      _.each(model.events, function (event) {
        ...
        returnData.series.headcount.push(_.get(event, "headcount.average") || 0);
        returnData.series.checkins.push(_.get(event, "checkins.length") || 0);
        returnData.series.expected.push(_.get(event, "stats.guestExpected") || 0);
      });
...
//# sourceMappingURL=team-98e32d77.js.map
