...
var css_248z = ".border-top[data-v-762111fe]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-762111fe]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-762111fe]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-762111fe]{border-left:1px solid rgba(0,0,0,.05)}.hint[data-v-762111fe]{font-size:10px;opacity:.5;color:inherit;display:block}";
...
//# sourceMappingURL=interaction-d9a55aa8.js.map
