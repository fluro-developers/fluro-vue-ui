...
import { r as FluroConfirmButton, bm as __vue_normalize__, bn as __vue_create_injector__, bo as _$1, aN as FluroContentForm, aO as FluroContentFormField } from './index-8dfc81d3.js';
...
import 'moment';
import { F as FluroContentEditMixin } from './FluroContentEditMixin-2d96f426.js';
import { FluroChart } from 'fluro-vue-ui';
import { F as FluroExclusiveSelector } from './FluroExclusiveSelector-b79f897f.js';
  ...
  computed: {
    ...
    genderBreakdown() {
      ...
      _.each(_.get(stats, "data.genders"), function (value, key) {
        returnData.model.labels.push(key);
        returnData.model.data.push(value);
      });
...
__vue_render__$4._withStripped = true;
  ...
  const __vue_inject_styles__$4 = function (inject) {
    if (!inject) return
    inject("data-v-04022c54_0", { source: "/**/\n.border-top {\n  border-top: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-right {\n  border-right: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-bottom {\n  border-bottom: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-left {\n  border-left: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n/**/\n\n/*# sourceMappingURL=MetricsDashboard.vue.map */", map: {"version":3,"sources":["C:\\Users\\User\\Documents\\fluro\\fluro-vue-ui\\src\\components\\MetricsDashboard.vue","MetricsDashboard.vue"],"names":[],"mappings":"AA8KA,GAAA;AAYA;EACA,yCAAA;ACxLA;AD2LA;EACA,2CAAA;ACxLA;AD2LA;EACA,4CAAA;ACxLA;AD2LA;EACA,0CAAA;ACxLA;;ADgMA,GAAA;;AC5LA,+CAA+C","file":"MetricsDashboard.vue","sourcesContent":["<template>\n    <div> METRICS DASHBOARD <template v-if=\"loading\"> Loading Component <v-progress-circular indeterminate></v-progress-circular>\n        </template>\n        <template v-else>\n            <h3>Attendance</h3>\n            <fluro-chart chartType=\"line\" :options=\"{}\" v-model=\"eventData.model\" :series=\"eventData.series\" :axis=\"eventData.axis\" />\n            <h3>Group Size</h3>\n            <fluro-chart chartType=\"line\" :options=\"{}\" v-model=\"groupSize.model\" :series=\"groupSize.series\" :axis=\"groupSize.axis\" />\n            <h3>Gender Breakdown</h3>\n            <fluro-chart chartType=\"pie\" :options=\"{}\" v-model=\"genderBreakdown.model\" :series=\"genderBreakdown.series\" />\n            <!-- Type: {{type}}  -->\n            <!-- Model:<pre>{{eventData}}</pre> -->\n            <!-- ID: -->\n            <!-- <pre>{{genderBreakdown}}</pre> -->\n        </template>\n    </div>\n</template>\n<script>\nimport { moment } from 'fluro';\nimport { FluroChart } from 'fluro-vue-ui';\nexport default {\n    components: {\n        FluroChart,\n    },\n    props: {\n        id: {\n            type: [Object, String],\n        },\n        type: {\n            type: String,\n        }\n    },\n    computed: {\n        eventData() {\n            var self = this\n            var model = {\n                axis: [],\n                series: {\n                    attendance: [],\n                    expected: [],\n                }\n            }\n            var events = _.sortBy(self.model.events, function(event) {\n                return event.startDate\n            })\n            _.each(events, function(event) {\n                //console.log(\"HERE\", event)\n                var headcount = _.get(event, \"headcount.average\") || 0\n                var checkins = _.get(event, \"checkins.length\") || 0\n                var attendance = Math.max(headcount, checkins, 0)\n                if (attendance > 0) {\n                    model.axis.push(event.startDate)\n                    model.series.attendance.push(attendance)\n                    model.series.expected.push(_.get(event, \"stats.guestExpected\") || 0)\n                }\n            })\n            return {\n                axis: {\n                    \"title\": \"Date\",\n                    \"key\": \"date\"\n                },\n                series: [\n                    // {\n                    //   \"title\": \"Headcount\",\n                    //   \"key\": \"headcount\"\n                    // },\n                    // {\n                    //   \"title\": \"Checkins\",\n                    //   \"key\": \"checkins\",\n                    // },\n                    {\n                        \"title\": \"Attendance\",\n                        \"key\": \"attendance\"\n                    }, {\n                        \"title\": \"Expected\",\n                        \"key\": \"expected\",\n                    },\n                ],\n                model\n            }\n        },\n        groupSize() {\n            var self = this;\n            var model = {\n                axis: [],\n                series: {\n                    groupsize: [],\n                }\n            }\n            var stats = _.sortBy(self.model.statsheets, function(stat) {\n                return stat.date\n            })\n            _.each(stats, function(stat) {\n                //console.log(\"HERE\", event)\n                model.axis.push(stat.date)\n                model.series.groupsize.push(_.get(stat, \"data.memberCount.total\"))\n            })\n            return {\n                axis: {\n                    \"title\": \"Date\",\n                    \"key\": \"date\"\n                },\n                series: [{\n                    \"title\": \"Members\",\n                    \"key\": \"groupsize\",\n                    AOT: true\n                }, ],\n                model\n            }\n        },\n        genderBreakdown() {\n            var self = this;\n            var stats = _.last(self.model.statsheets)\n            var returnData = {\n                model: {\n                    labels: [],\n                    data: []\n                },\n                series: [{\n                    title: \"Gender Composition\",\n                    key: \"gender\"\n                }]\n            }\n            _.each(_.get(stats, \"data.genders\"), function(value, key) {\n                returnData.model.labels.push(key)\n                returnData.model.data.push(value)\n            })\n            console.log(\"Gender Graph Data\", returnData)\n            return returnData\n        }\n    },\n    asyncComputed: {\n        model: {\n            // default: {},\n            get() {\n                var self = this;\n                var id = self.$fluro.utils.getStringID(self.id);\n                return new Promise(function(resolve, reject) {\n                    //Load the chart data\n                    switch (self.type) {\n                        case 'team':\n                            var endpoint = `chart/groups/${id}/simple`\n                            self.$fluro.api.get(endpoint, {\n                                params: {\n                                    startDate: moment().subtract(1, 'year').toDate(),\n                                    endDate: moment().toDate(),\n                                }\n                            }).then(function(res) {\n                                resolve(res.data);\n                                self.loading = false;\n                            }, function(err) {\n                                reject(err);\n                                self.loading = false;\n                            });\n                            break;\n                        case 'realm':\n                            break;\n                        case 'contact':\n                            break;\n                    }\n                })\n            }\n        }\n    },\n    data() {\n        return {\n            loading: true,\n        }\n    }\n}\n\n</script>\n<style lang=\"scss\">\n\n/**/\r\n\r\n$primary: #2ad4b9;//#0bd6be;\r\n$success: #4cc650; //#4cc673;//\r\n$warning: #f0974e; //darken(#fbf2d2, 50%);//#f0974e;\r\n$danger: #d93e63;\r\n$secondary: #0bd6cd; //#0bd6a3;\r\n\r\n\r\n\r\n//////////////////////////////////////////\r\n\r\n.border-top {\r\n    border-top: 1px solid rgba(#000, 0.05);\r\n}\r\n\r\n.border-right {\r\n    border-right: 1px solid rgba(#000, 0.05);\r\n}\r\n\r\n.border-bottom {\r\n    border-bottom: 1px solid rgba(#000, 0.05);\r\n}\r\n\r\n.border-left {\r\n    border-left: 1px solid rgba(#000, 0.05);\r\n}\r\n//////////////////////////////////////////\r\n\r\n\r\n\r\n\r\n//////////////////////////////////////////\r\n/**/\n</style>\n","/**/\n.border-top {\n  border-top: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-right {\n  border-right: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-bottom {\n  border-bottom: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-left {\n  border-left: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n/**/\n\n/*# sourceMappingURL=MetricsDashboard.vue.map */"]}, media: undefined });
...
//# sourceMappingURL=team-cd4b0d0a.js.map
