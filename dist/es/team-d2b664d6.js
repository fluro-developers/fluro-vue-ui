...
import { r as FluroConfirmButton, bm as __vue_normalize__, bn as __vue_create_injector__, bo as _$1, aN as FluroContentForm, aO as FluroContentFormField } from './index-1ebb2888.js';
...
import 'moment';
import { F as FluroContentEditMixin } from './FluroContentEditMixin-c8003e2a.js';
import { FluroChart } from 'fluro-vue-ui';
import { F as FluroExclusiveSelector } from './FluroExclusiveSelector-c7d2c05f.js';
...
var script$4 = {
  ...
  computed: {
    ...
    ageSpread() {
      ...
      var ageSpread = statbase.data.spread;
      var averageAge = statbase.data.ages.average;
      var groupedAges = new Array(8).fill(0);

      _.each(ageSpread, function (value) {
        switch (true) {
          case value < 16:
            groupedAges[0] = groupedAges[0] + 1;
            break;

          case value < 26:
            groupedAges[1] = groupedAges[1] + 1;
            break;

          case value < 36:
            groupedAges[2] = groupedAges[2] + 1;
            break;

          case value < 46:
            groupedAges[3] = groupedAges[3] + 1;
            break;

          case value < 56:
            groupedAges[4] = groupedAges[4] + 1;
            break;

          case value < 66:
            groupedAges[5] = groupedAges[5] + 1;
            break;

          case value < 76:
            groupedAges[6] = groupedAges[6] + 1;
            break;

          case value >= 76:
            groupedAges[7] = groupedAges[7] + 1;
            break;
        }
      });
      ...
      var model = {
        ...
        data: {
          ...
          agerageage: new Array(8).fill(averageAge)
        }
      };
      var returnData = {
        model,
...
var __vue_render__$4 = function() {
  ...
  return _c(
    ...
    [
      _vm.loading
        ? [
            _vm._v(" Loading Component "),
            _c("v-progress-circular", { attrs: { indeterminate: "" } })
          ]
        : [
            _vm.eventData.model.series.attendance.length
              ? _c(
                  "div",
                  [
                    _c("h3", [_vm._v("Event Attendance")]),
                    _vm._v(" "),
                    _c("fluro-chart", {
                      attrs: {
                        chartType: "line",
                        options: _vm.eventData.options,
                        series: _vm.eventData.series,
                        axis: _vm.eventData.axis
                      },
                      model: {
                        value: _vm.eventData.model,
                        callback: function($$v) {
                          _vm.$set(_vm.eventData, "model", $$v);
                        },
                        expression: "eventData.model"
                      }
                    })
                  ],
                  1
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.groupSize.model.series.groupsize.length
              ? _c(
                  "div",
                  [
                    _c("h3", [_vm._v("Group Size")]),
                    _vm._v(" "),
                    _c("fluro-chart", {
                      attrs: {
                        chartType: "line",
                        options: _vm.groupSize.options,
                        series: _vm.groupSize.series,
                        axis: _vm.groupSize.axis
                      },
                      model: {
                        value: _vm.groupSize.model,
                        callback: function($$v) {
                          _vm.$set(_vm.groupSize, "model", $$v);
                        },
                        expression: "groupSize.model"
                      }
                    })
                  ],
                  1
            ...
            _vm.groupSize.model.series.groupsize.length
              ? _c(
                  "div",
                  [
                    _c("h3", [_vm._v("Gender Breakdown")]),
                    _vm._v(" "),
                    _c("fluro-chart", {
                      attrs: {
                        chartType: "pie",
                        options: _vm.genderBreakdown.options,
                        series: _vm.genderBreakdown.series
                      },
                      model: {
                        value: _vm.genderBreakdown.model,
                        callback: function($$v) {
                          _vm.$set(_vm.genderBreakdown, "model", $$v);
                        },
                        expression: "genderBreakdown.model"
                      }
                    })
                  ],
                  1
            ...
            _c(
              "div",
              [
                _c("h3", [_vm._v("Age Breakdown")]),
                _vm._v(" "),
                _c("fluro-chart", {
                  attrs: {
                    chartType: "line",
                    options: _vm.ageSpread.options,
                    series: _vm.ageSpread.series
                  },
                  model: {
                    value: _vm.ageSpread.model,
                    callback: function($$v) {
                      _vm.$set(_vm.ageSpread, "model", $$v);
                    },
                    expression: "ageSpread.model"
                  }
                })
              ],
              1
                      ...
                      _c(
                        ...
                        [
                          _c(
                            ...
                            { attrs: { md: "" } },
                            [
                              _c("metrics-dashboard", {
                                attrs: { id: _vm.model, type: "team" }
                              })
                            ],
                            1
                          )
...
//# sourceMappingURL=team-d2b664d6.js.map
