...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-4109bbea_0", { source: ".border-top[data-v-4109bbea]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-4109bbea]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-4109bbea]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-4109bbea]{border-left:1px solid rgba(0,0,0,.05)}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-4109bbea";
  /* module identifier */
...
//# sourceMappingURL=collection-6fde4b6c.js.map
