import { b5 as MailoutRenderPreview, b6 as MailoutTestPanel, b8 as MailoutResultsPanel, b7 as MailoutPreflightPanel, be as styleInject, bf as __vue_normalize__ } from './index-75551cc4.js';
import Vue from 'vue';
import 'vuedraggable';
import 'vue-color';
...
var css_248z = ".border-top[data-v-515eed9a]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-515eed9a]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-515eed9a],.row-item[data-v-515eed9a]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-515eed9a]{border-left:1px solid rgba(0,0,0,.05)}.row-item[data-v-515eed9a]{display:block;padding:10px;color:inherit;text-decoration:none}.row-item[data-v-515eed9a]:hover{background:#fafafa}.stat-box[data-v-515eed9a]{padding:10px;border:1px solid rgba(0,0,0,.1);border-radius:3px;text-align:center;margin:2px;background:-webkit-gradient(linear,left top,left bottom,from(#fff),to(#fafafa));background:-o-linear-gradient(#fff,#fafafa);background:linear-gradient(#fff,#fafafa)}.stat-box label[data-v-515eed9a]{text-transform:uppercase;font-weight:500;font-size:10px;opacity:.5;letter-spacing:.05em}.stat-box h3[data-v-515eed9a]{font-size:40px;display:block;line-height:50px}";
...
//# sourceMappingURL=mailout-564bd003.js.map
