import { aG as FluroCodeEditor, bh as _, bf as styleInject, bg as __vue_normalize__ } from './index-7b32a04b.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
import { F as FluroAssetEditMixin } from './FluroAssetEditMixin-891a0e61.js';
...
var css_248z$1 = ".border-top[data-v-78e32f66]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-78e32f66]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-78e32f66]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-78e32f66]{border-left:1px solid rgba(0,0,0,.05)}.color-swatch[data-v-78e32f66]{width:36px;height:36px;border-radius:3px;margin:0 1px 1px 0;display:inline-block}";
...
//# sourceMappingURL=video-0fbfc2ca.js.map
