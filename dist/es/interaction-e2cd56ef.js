...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-e2a01e08_0", { source: ".border-top[data-v-e2a01e08]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-e2a01e08]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-e2a01e08]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-e2a01e08]{border-left:1px solid rgba(0,0,0,.05)}", map: undefined, media: undefined });
...
//# sourceMappingURL=interaction-e2cd56ef.js.map
