...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-589c1f94_0", { source: ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}.invite-code{line-height:60px;height:60px;padding:0 5px;border:1px solid rgba(42,212,185,.5);background:rgba(42,212,185,.1);text-align:center;font-weight:100;font-size:40px}", map: undefined, media: undefined });
...
//# sourceMappingURL=policy-eb183598.js.map
