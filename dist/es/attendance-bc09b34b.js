import { aJ as FluroContentForm, o as FluroConfirmButton, be as styleInject, bf as __vue_normalize__ } from './index-d9bb0a3e.js';
import 'vue';
...
var css_248z$1 = ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}.no-border-no-background .toggle-item{border:0!important;background:0 0!important;font-size:14px;padding:0}";
...
//# sourceMappingURL=attendance-bc09b34b.js.map
