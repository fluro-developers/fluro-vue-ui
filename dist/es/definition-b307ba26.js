...
import { r as FluroConfirmButton, bo as _$1, bm as __vue_normalize__, bn as __vue_create_injector__, c as FluroHelp, aL as FluroExpressionEditor, e as FluroModalMixin, aO as FluroContentFormField, az as FluroAccordion, aA as FluroAccordionPanel, h as FluroFieldEditor, aG as FluroContentSelectButton, aK as FluroCodeEditor, b9 as MailoutRenderPreview, bq as FieldTemplates } from './index-10c22fc5.js';
import 'vue';
...
import 'moment';
import { F as FluroContentEditMixin } from './FluroContentEditMixin-91e796ae.js';
...
__vue_render__$5._withStripped = true;
  ...
  const __vue_inject_styles__$5 = function (inject) {
    if (!inject) return
    inject("data-v-5681d271_0", { source: "/**/\n.border-top {\n  border-top: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-right {\n  border-right: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-bottom {\n  border-bottom: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-left {\n  border-left: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n/**/\n\n/*# sourceMappingURL=FluroColumnSelect.vue.map */", map: {"version":3,"sources":["/Users/cadeembery/Code/fluro-vue-ui/src/components/content/edit/components/FluroColumnSelect.vue","FluroColumnSelect.vue"],"names":[],"mappings":"AAqDA,GAAA;AAYA;EACA,yCAAA;AC/DA;ADkEA;EACA,2CAAA;AC/DA;ADkEA;EACA,4CAAA;AC/DA;ADkEA;EACA,0CAAA;AC/DA;;ADuEA,GAAA;;ACnEA,gDAAgD","file":"FluroColumnSelect.vue","sourcesContent":["<template>\n\t\t\t\t<fluro-panel >\n\t\t\t\t\t\t\t\t<fluro-panel-body class=\"border-bottom\" :key=\"index\" v-for=\"(column, index) in model\">\n\t\t\t\t\t\t\t\t\t\t\t\t<fluro-column-select-item v-model=\"model[index]\" />\n\t\t\t\t\t\t\t\t</fluro-panel-body>\n\t\t\t\t\t\t\t\t<fluro-panel-body>\n\t\t\t\t\t\t\t\t\t\t\t\t<v-btn @click=\"add()\">Add item</v-btn>\n\n\t\t\t\t\t\t\t\t</fluro-panel-body>\n\t\t\t\t</fluro-panel>\n</template>\n<script>\nimport FluroColumnSelectItem from 'src/components/content/edit/components/FluroColumnSelectItem.vue';\n\nexport default {\n\t\t\t\tprops: {\n\t\t\t\t\t\t\t\tvalue: {\n\t\t\t\t\t\t\t\t\t\t\t\ttype: Array,\n\t\t\t\t\t\t\t\t\t\t\t\tdefault () {\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\treturn [];\n\t\t\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t}\n\t\t\t\t},\n\t\t\t\tdata() {\n\t\t\t\t\t\t\t\treturn {\n\t\t\t\t\t\t\t\t\t\t\t\tmodel: this.value,\n\t\t\t\t\t\t\t\t}\n\t\t\t\t},\n\t\t\t\tcomponents: {\n\t\t\t\t\t\t\t\tFluroColumnSelectItem,\n\t\t\t\t},\n\t\t\t\tmethods: {\n\t\t\t\t\t\t\t\tadd() {\n\t\t\t\t\t\t\t\t\t\t\t\tthis.model.push({});\n\t\t\t\t\t\t\t\t},\n\t\t\t\t},\n\t\t\t\tcomputed: {},\n\t\t\t\twatch: {\n\t\t\t\t\t\t\t\tvalue(v) {\n\t\t\t\t\t\t\t\t\t\t\t\tif (v != this.model) {\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tthis.model = v;\n\t\t\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t},\n\t\t\t\t\t\t\t\tmodel(v) {\n\t\t\t\t\t\t\t\t\t\t\t\tthis.$emit('input', v);\n\t\t\t\t\t\t\t\t}\n\t\t\t\t},\n\n}\n\n</script>\n<style lang=\"scss\">\n\n/**/\n\n$primary: #2ad4b9;//#0bd6be;\n$success: #4cc650; //#4cc673;//\n$warning: #f0974e; //darken(#fbf2d2, 50%);//#f0974e;\n$danger: #d93e63;\n$secondary: #0bd6cd; //#0bd6a3;\n\n\n\n//////////////////////////////////////////\n\n.border-top {\n    border-top: 1px solid rgba(#000, 0.05);\n}\n\n.border-right {\n    border-right: 1px solid rgba(#000, 0.05);\n}\n\n.border-bottom {\n    border-bottom: 1px solid rgba(#000, 0.05);\n}\n\n.border-left {\n    border-left: 1px solid rgba(#000, 0.05);\n}\n//////////////////////////////////////////\n\n\n\n\n//////////////////////////////////////////\n/**/\n</style>\n","/**/\n.border-top {\n  border-top: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-right {\n  border-right: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-bottom {\n  border-bottom: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-left {\n  border-left: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n/**/\n\n/*# sourceMappingURL=FluroColumnSelect.vue.map */"]}, media: undefined });
...
var script$6 = {
  components: {
    ...
    FluroColumnSelect: __vue_component__$5,
    FluroCodeEditor,
    MailoutRenderPreview //RosterSlotManager,
    // FluroEditor,
  ...
  methods: {
    ...
    incrementCacheKey: _$1.debounce(function () {
                ...
                _vm.isForm
                  ...
                  : [
                      ...
                      _vm.fieldsMakeSense
                        ...
                        : _vm._e(),
                      _vm._v(" "),
                      _vm.model.parentType == "mailout"
                        ? _c(
                            "tab",
                            { attrs: { heading: "Template" } },
                            [
                              _c(
                                "flex-row",
                                ...
                                [
                                  _c(
                                    "flex-column",
                                    {
                                      ...
                                      class: {
                                        "panel-collapsed": _vm.collapsed.html
                                      }
                                    },
                                    [
                                      _c(
                                  ...
                                  _c(
                                    "flex-column",
                                    {
                                      staticClass: "code-panel",
                                      class: {
                                        "panel-collapsed": _vm.collapsed.css
                                      }
                                    },
                                    [
                                      _c(
                                  ...
                                  _c(
                                    "flex-column",
                                    {
                                      staticClass: "code-panel light",
                                      class: {
                                        "panel-collapsed": _vm.collapsed.preview
                                      }
                                    },
                                    [
                                      _c(
                                        "div",
                                        {
                                          ...
                                          on: {
                                            click: function($event) {
                                              return _vm.togglePanel("preview")
                                            }
                                          }
                                        },
                                        [
                                      ...
                                      _c(
                                        ...
                                        [
                                          _c("mailout-render-preview", {
                                            attrs: {
                                              live: true,
                                              cacheKey: _vm.mailoutCacheKey,
                                              definition:
                                                _vm.model.definitionName
                                            }
                                          })
                                        ],
                                        1
                                  ...
                                  _c(
                                    "flex-column",
                                    {
                                      staticClass: "code-panel light",
                                      class: {
                                        "panel-collapsed": _vm.collapsed.tokens
                                      }
                                    },
                                    [
                                      _c(
                                                          ...
                                                          _c(
                                                            ...
                                                            [
                                                              ...
                                                              _c(
                                                                ...
                                                                [
                                                                  _vm._v(
                                                                    "\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<% for (var i = 0; i < get('items.length'); i++) { %>"
                                                                  ),
                                                                  _c("br"),
                                                                  _vm._v(
                                                                    "\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<h3>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<%= get('items[i].title') %></h3>"
                                                                  ),
                                                                  _c("br"),
                                                                  _vm._v(
                                                                    "\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<% } %>\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t"
                                                          ...
                                                          _c(
                                                            ...
                                                            [
                                                              ...
                                                              _c(
                                                                ...
                                                                [
                                                                  _vm._v(
                                                                    "Font library, the icon name, and an optional color"
                                                                  )
                                                                ]
                                                              ),
                                                              _vm._v(" "),
                                                          ...
                                                          _c(
                                                            ...
                                                            [
                                                              ...
                                                              _c(
                                                                ...
                                                                [
                                                                  _vm._v(
                                                                    "Generated by providing a path to the image on the mailout data"
                                                                  )
                                                                ]
                                                              ),
                                                              _vm._v(" "),
                                                          ...
                                                          _c(
                                                            ...
                                                            [
                                                              ...
                                                              _c(
                                                                ...
                                                                [
                                                                  _vm._v(
                                                                    "Generated by providing a static ID"
                                                                  )
                                                                ]
                                                              ),
                                                              _vm._v(" "),
...
//# sourceMappingURL=definition-b307ba26.js.map
