<<<<<<< HEAD:dist/es/image-a71a4d52.js
...
>>>>>>> e97e30815b0dc9fa78df2edbb47266484ec56bb6:dist/es/image-0aa87674.js
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
import { F as FluroAssetEditMixin } from './FluroAssetEditMixin-7cdf37d4.js';
>>>>>>> e97e30815b0dc9fa78df2edbb47266484ec56bb6:dist/es/image-0aa87674.js
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-25d45404_0", { source: ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}.media-preview{background:#eee;display:block;min-height:350px;margin-bottom:15px;border:1px solid rgba(0,0,0,.1);border-radius:5px;overflow:hidden}.media-preview .media-preview-wrap{max-width:750px;margin:auto}", map: undefined, media: undefined })
,inject("data-v-25d45404_1", { source: ".border-top[data-v-25d45404]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-25d45404]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-25d45404]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-25d45404]{border-left:1px solid rgba(0,0,0,.05)}.color-swatch[data-v-25d45404]{width:36px;height:36px;border-radius:3px;margin:0 1px 1px 0;display:inline-block}", map: undefined, media: undefined });
...
<<<<<<< HEAD:dist/es/image-a71a4d52.js
//# sourceMappingURL=image-a71a4d52.js.map
=======
//# sourceMappingURL=image-0aa87674.js.map
>>>>>>> e97e30815b0dc9fa78df2edbb47266484ec56bb6:dist/es/image-0aa87674.js
