import { ae as FluroContentView, bh as _, bf as styleInject, bg as __vue_normalize__ } from './index-9c9e4101.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
import { M as MessagingEventManager, L as LocationSelector } from './LocationSelector-cbdd0b22.js';
import { G as GuestList, T as TicketList, L as LocationViewMapComponent } from './TicketList-cfefec19.js';
...
var css_248z = ".border-top[data-v-a65d65aa]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-a65d65aa]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-a65d65aa]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-a65d65aa]{border-left:1px solid rgba(0,0,0,.05)}.event-cover-image[data-v-a65d65aa]{border-radius:5px;width:90%;padding-bottom:70%;background-repeat:no-repeat;background-position:center;background-size:cover;display:block;margin:5%}.hint[data-v-a65d65aa]{font-size:10px;opacity:.5;color:inherit;display:block}.copystring[data-v-a65d65aa]{width:100%;overflow:auto;display:block;background:#eee;border-radius:3px;opacity:.5;padding:10px;line-height:20px}.copystring[data-v-a65d65aa]:hover{opacity:1}.assignment-item[data-v-a65d65aa]{font-size:12px;-o-text-overflow:ellipsis;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;border-radius:100px;margin-bottom:2px;padding:2px 10px;font-weight:500;background-color:rgba(0,0,0,.05)}.assignment-item.confirmed[data-v-a65d65aa]{color:#4cc650;background-color:rgba(76,198,80,.05)}.assignment-item.denied[data-v-a65d65aa]{color:#d93e63;background-color:rgba(217,62,99,.05)}.assignment-item.unknown[data-v-a65d65aa]{color:#555}.assignment-item.proposed[data-v-a65d65aa]{background-color:rgba(42,212,185,.1);color:#197f6f}.btn-ghost[data-v-a65d65aa]{border:1px dashed #555;color:#555;opacity:.5}.btn-ghost[data-v-a65d65aa]:hover{opacity:1}.bordered[data-v-a65d65aa]{border:1px solid rgba(0,0,0,.1);-webkit-box-shadow:0 2px 4px rgba(0,0,0,.1);box-shadow:0 2px 4px rgba(0,0,0,.1)}.bordered[data-v-a65d65aa] .tabset-menu{background:#eee}";
...
var __vue_staticRenderFns__ = [];
  ...
  /* scoped */
  const __vue_scope_id__ = "data-v-a65d65aa";
  /* module identifier */
...
//# sourceMappingURL=event-3ff33c0c.js.map
