import { ad as FluroContentView, ai as FluroTaskList, bg as _, bj as _objectSpread2, be as styleInject, bf as __vue_normalize__ } from './index-78607ce6.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
var css_248z = ".border-top[data-v-7aa263ce]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-7aa263ce]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-7aa263ce]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-7aa263ce]{border-left:1px solid rgba(0,0,0,.05)}.hint[data-v-7aa263ce]{font-size:10px;opacity:.5;color:inherit;display:block}.main[data-v-7aa263ce],.sidebar[data-v-7aa263ce]{-webkit-box-flex:1;-ms-flex:1;flex:1;overflow:hidden;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.horizontal-rule[data-v-7aa263ce]{display:block;border-radius:20px;height:3px;background:rgba(0,0,0,.1);margin:10px 0}.sidebar[data-v-7aa263ce]{background:rgba(0,0,0,.02)}@media (min-width:769px){.sidebar[data-v-7aa263ce]{border-left:1px solid rgba(0,0,0,.05)}}.bordered[data-v-7aa263ce]{border:1px solid rgba(0,0,0,.1);-webkit-box-shadow:0 2px 4px rgba(0,0,0,.1);box-shadow:0 2px 4px rgba(0,0,0,.1)}.bordered[data-v-7aa263ce] .tabset-menu{background:#eee}";
...
//# sourceMappingURL=process-a206eaf4.js.map
