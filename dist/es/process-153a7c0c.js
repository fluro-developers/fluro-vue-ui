import { ae as FluroContentView, aj as FluroTaskList, bh as _, bk as _objectSpread2, bf as styleInject, bg as __vue_normalize__ } from './index-7b32a04b.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
var css_248z = ".border-top[data-v-c98a3738]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-c98a3738]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-c98a3738]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-c98a3738]{border-left:1px solid rgba(0,0,0,.05)}.hint[data-v-c98a3738]{font-size:10px;opacity:.5;color:inherit;display:block}.main[data-v-c98a3738],.sidebar[data-v-c98a3738]{-webkit-box-flex:1;-ms-flex:1;flex:1;overflow:hidden;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.horizontal-rule[data-v-c98a3738]{display:block;border-radius:20px;height:3px;background:rgba(0,0,0,.1);margin:10px 0}.sidebar[data-v-c98a3738]{background:rgba(0,0,0,.02)}@media (min-width:769px){.sidebar[data-v-c98a3738]{border-left:1px solid rgba(0,0,0,.05)}}.bordered[data-v-c98a3738]{border:1px solid rgba(0,0,0,.1);-webkit-box-shadow:0 2px 4px rgba(0,0,0,.1);box-shadow:0 2px 4px rgba(0,0,0,.1)}.bordered[data-v-c98a3738] .tabset-menu{background:#eee}";
...
//# sourceMappingURL=process-153a7c0c.js.map
