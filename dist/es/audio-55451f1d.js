import { aj as FluroContentRender, bh as __vue_normalize__, bi as __vue_create_injector__ } from './index-20f019b0.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
import { F as FluroDefinedList } from './FluroDefinedList-b3a39f19.js';
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-2d9a08a6_0", { source: ".border-top[data-v-2d9a08a6]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-2d9a08a6]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-2d9a08a6]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-2d9a08a6]{border-left:1px solid rgba(0,0,0,.05)}.image-holder[data-v-2d9a08a6]{background:#111;max-height:50vh;overflow:hidden;display:flex}.color-swatch[data-v-2d9a08a6]{width:36px;height:36px;border-radius:3px;margin:0 1px 1px 0;display:inline-block}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-2d9a08a6";
  /* module identifier */
...
//# sourceMappingURL=audio-55451f1d.js.map
