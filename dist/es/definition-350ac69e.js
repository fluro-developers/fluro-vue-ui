import { n as FluroConfirmButton, bf as _$1, bd as __vue_normalize__, be as __vue_create_injector__, aG as FluroExpressionEditor, b as FluroModalMixin, aJ as FluroContentFormField, e as FluroFieldEditor, aB as FluroContentSelectButton, bh as FieldTemplates } from './index-6d63e94d.js';
import 'vue';
...
import { F as FluroContentEditMixin } from './FluroContentEditMixin-b6de99f3.js';
...
var script$4 = {
  ...
  components: {
    FluroColumnSelectItem: __vue_component__$3
  },
  methods: {
    add() {
      this.model.push({});
...
/* template */
var __vue_render__$4 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('fluro-panel',[_vm._l((_vm.model),function(column,index){return _c('fluro-panel-body',{key:index,staticClass:"border-bottom"},[_c('fluro-column-select-item',{model:{value:(_vm.model[index]),callback:function ($$v) {_vm.$set(_vm.model, index, $$v);},expression:"model[index]"}})],1)}),_vm._v(" "),_c('fluro-panel-body',[_c('v-btn',{on:{"click":function($event){return _vm.add()}}},[_vm._v("Add item")])],1)],2)};
...
var script$5 = {
  components: {
    ...
    PaymentModifierEditor: __vue_component__$2,
    FluroColumnSelect: __vue_component__$4 // FluroEditor,
...
var __vue_staticRenderFns__$5 = [];
  ...
  const __vue_inject_styles__$5 = function (inject) {
    if (!inject) return
    inject("data-v-066fdada_0", { source: ".border-top[data-v-066fdada]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-066fdada]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-066fdada]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-066fdada]{border-left:1px solid rgba(0,0,0,.05)}.field-row[data-v-066fdada]{padding:0 15px;border-bottom:1px solid rgba(0,0,0,.1)}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$5 = "data-v-066fdada";
  /* module identifier */
...
//# sourceMappingURL=definition-350ac69e.js.map
