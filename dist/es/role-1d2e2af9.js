import { a4 as FluroToggleItem, S as SearchInput, bf as _, bd as __vue_normalize__, be as __vue_create_injector__ } from './index-a980501b.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-54b7dbb1_0", { source: ".border-top[data-v-54b7dbb1]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-54b7dbb1]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-54b7dbb1]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-54b7dbb1]{border-left:1px solid rgba(0,0,0,.05)}.search-box[data-v-54b7dbb1]{padding:10px}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-54b7dbb1";
  /* module identifier */
...
//# sourceMappingURL=role-1d2e2af9.js.map
