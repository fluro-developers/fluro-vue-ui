import { ab as FluroContentView, ag as FluroTaskList, be as _, bh as _objectSpread2, bc as __vue_normalize__, bd as __vue_create_injector__ } from './index-f7c481db.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-342a0eb6_0", { source: ".border-top[data-v-342a0eb6]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-342a0eb6]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-342a0eb6]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-342a0eb6]{border-left:1px solid rgba(0,0,0,.05)}.hint[data-v-342a0eb6]{font-size:10px;opacity:.5;color:inherit;display:block}.main[data-v-342a0eb6],.sidebar[data-v-342a0eb6]{flex:1;overflow:hidden;display:flex;flex-direction:column}.horizontal-rule[data-v-342a0eb6]{display:block;border-radius:20px;height:3px;background:rgba(0,0,0,.1);margin:10px 0}.sidebar[data-v-342a0eb6]{background:rgba(0,0,0,.02)}@media (min-width:769px){.sidebar[data-v-342a0eb6]{border-left:1px solid rgba(0,0,0,.05)}}.bordered[data-v-342a0eb6]{border:1px solid rgba(0,0,0,.1);box-shadow:0 2px 4px rgba(0,0,0,.1)}.bordered[data-v-342a0eb6] .tabset-menu{background:#eee}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-342a0eb6";
  /* module identifier */
...
//# sourceMappingURL=process-2a6c56be.js.map
