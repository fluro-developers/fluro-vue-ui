import { bc as __vue_normalize__, bd as __vue_create_injector__, m as FluroConfirmButton, be as _, ac as FilterConditionGroup } from './index-e7a8996d.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
var __vue_staticRenderFns__$2 = [];
  ...
  const __vue_inject_styles__$2 = function (inject) {
    if (!inject) return
    inject("data-v-239975cd_0", { source: ".border-top[data-v-239975cd]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-239975cd]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-239975cd]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-239975cd]{border-left:1px solid rgba(0,0,0,.05)}.hint[data-v-239975cd]{font-size:10px;opacity:.5;color:inherit;display:block}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$2 = "data-v-239975cd";
  /* module identifier */
...
//# sourceMappingURL=query-9893ca58.js.map
