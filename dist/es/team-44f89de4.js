...
import { r as FluroConfirmButton, bm as __vue_normalize__, bn as __vue_create_injector__, bo as _$1, aN as FluroContentForm, aO as FluroContentFormField } from './index-34b5f40a.js';
...
import { F as FluroExclusiveSelector } from './FluroExclusiveSelector-24ffa43e.js';
...
__vue_render__$4._withStripped = true;
  ...
  const __vue_inject_styles__$4 = function (inject) {
    if (!inject) return
    inject("data-v-05a8388b_0", { source: "/**/\n.border-top {\n  border-top: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-right {\n  border-right: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-bottom {\n  border-bottom: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-left {\n  border-left: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n/**/\n\n/*# sourceMappingURL=MetricsDashboard.vue.map */", map: {"version":3,"sources":["C:\\Users\\User\\Documents\\fluro\\fluro-vue-ui\\src\\components\\MetricsDashboard.vue","MetricsDashboard.vue"],"names":[],"mappings":"AAsDA,GAAA;AAYA;EACA,yCAAA;AChEA;ADmEA;EACA,2CAAA;AChEA;ADmEA;EACA,4CAAA;AChEA;ADmEA;EACA,0CAAA;AChEA;;ADwEA,GAAA;;ACpEA,+CAA+C","file":"MetricsDashboard.vue","sourcesContent":["<template>\n\t<div>\n\t\tMETRICS DASHBOARD\n\t\t{{model}}\n\t\t{{id}}\n\t\t{{type}}\n\t</div>\n</template>\n<script>\n\t\nexport default {\n\tprops:{\n\t\tid:{\n\t\t\ttype:[Object, String],\n\t\t},\n\t\ttype:{\n\t\t\ttype:String,\n\t\t}\n\t},\n\tcomputed:{\n\n\t},\n\tasyncComputed:{\n\t\tmodel:{\n\t\t\tdefault:{},\n\t\t\tget() {\n\n\t\t\t\tvar self = this;\n\n\t\t\t\tvar id = self.$fluro.utils.getStringID(self.id);\n\n\n\n\t\t\t\treturn new Promise(function(resolve, reject) {\n\t\t\t\t\t//Load the chart data\n\n\t\t\t\t\tswitch(self.type) {\n\t\t\t\t\t\tcase 'team':\n\t\t\t\t\t\tbreak;\n\t\t\t\t\t\tcase 'realm':\n\t\t\t\t\t\tbreak;\n\t\t\t\t\t\tcase 'contact':\n\t\t\t\t\t\tbreak;\n\t\t\t\t\t}\n\t\t\t\t})\n\t\t\t}\n\t\t}\n\t}\n}\n\n</script>\n\n<style lang=\"scss\">\n\n/**/\r\n\r\n$primary: #2ad4b9;//#0bd6be;\r\n$success: #4cc650; //#4cc673;//\r\n$warning: #f0974e; //darken(#fbf2d2, 50%);//#f0974e;\r\n$danger: #d93e63;\r\n$secondary: #0bd6cd; //#0bd6a3;\r\n\r\n\r\n\r\n//////////////////////////////////////////\r\n\r\n.border-top {\r\n    border-top: 1px solid rgba(#000, 0.05);\r\n}\r\n\r\n.border-right {\r\n    border-right: 1px solid rgba(#000, 0.05);\r\n}\r\n\r\n.border-bottom {\r\n    border-bottom: 1px solid rgba(#000, 0.05);\r\n}\r\n\r\n.border-left {\r\n    border-left: 1px solid rgba(#000, 0.05);\r\n}\r\n//////////////////////////////////////////\r\n\r\n\r\n\r\n\r\n//////////////////////////////////////////\r\n/**/\n\t\n</style>","/**/\n.border-top {\n  border-top: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-right {\n  border-right: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-bottom {\n  border-bottom: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-left {\n  border-left: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n/**/\n\n/*# sourceMappingURL=MetricsDashboard.vue.map */"]}, media: undefined });
...
//# sourceMappingURL=team-44f89de4.js.map
