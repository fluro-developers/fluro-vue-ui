<<<<<<< HEAD:dist/es/FluroAssetEditMixin-845116e2.js
import { bh as _, bf as __vue_normalize__, bg as __vue_create_injector__ } from './index-204ee3c0.js';
=======
import { bi as _, bg as __vue_normalize__, bh as __vue_create_injector__ } from './index-8d7f8f94.js';
>>>>>>> e97e30815b0dc9fa78df2edbb47266484ec56bb6:dist/es/FluroAssetEditMixin-7cdf37d4.js
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-270dd647_0", { source: ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}.file-drop{display:block;position:relative;border:1px dashed rgba(0,0,0,.2);background:rgba(0,0,0,.05);padding:10px;border-radius:10px;text-align:center;min-height:60px;cursor:pointer;display:flex;align-items:center;justify-content:center;font-size:.8;font-style:italic;color:rgba(0,0,0,.5);margin-bottom:5px}.file-drop:active,.file-drop:focus,.file-drop:hover{background:#fff}.file-drop input{display:block;left:0;right:0;bottom:0;top:0;opacity:0;width:100%;height:100%;position:absolute;cursor:pointer}.file-items{margin-bottom:15px}.file-items .file-item{position:relative;padding:5px 5px 5px 15px;border:1px solid rgba(0,0,0,.2);border-bottom:none;background:#fff;font-size:.9em}.file-items .file-item:first-child{border-radius:5px 5px 0 0}.file-items .file-item:last-child{border-bottom:1px solid rgba(0,0,0,.2);border-radius:0 0 5px 5px}", map: undefined, media: undefined });
...
<<<<<<< HEAD:dist/es/FluroAssetEditMixin-845116e2.js
//# sourceMappingURL=FluroAssetEditMixin-845116e2.js.map
=======
//# sourceMappingURL=FluroAssetEditMixin-7cdf37d4.js.map
>>>>>>> e97e30815b0dc9fa78df2edbb47266484ec56bb6:dist/es/FluroAssetEditMixin-7cdf37d4.js
