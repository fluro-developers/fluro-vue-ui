import { aG as FluroCodeEditor, bh as _, bf as __vue_normalize__, bg as __vue_create_injector__ } from './index-87fb1a77.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
import { F as FluroAssetEditMixin } from './FluroAssetEditMixin-edfb6471.js';
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-78e32f66_0", { source: ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}.media-preview{background:#eee;display:block;min-height:350px;margin-bottom:15px;border:1px solid rgba(0,0,0,.1);border-radius:5px;overflow:hidden}.media-preview .media-preview-wrap{max-width:750px;margin:auto}", map: undefined, media: undefined })
,inject("data-v-78e32f66_1", { source: ".border-top[data-v-78e32f66]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-78e32f66]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-78e32f66]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-78e32f66]{border-left:1px solid rgba(0,0,0,.05)}.color-swatch[data-v-78e32f66]{width:36px;height:36px;border-radius:3px;margin:0 1px 1px 0;display:inline-block}", map: undefined, media: undefined });
...
//# sourceMappingURL=video-2e950856.js.map
