import { ah as FluroContentRender, bf as __vue_normalize__, bg as __vue_create_injector__ } from './index-1002a7a6.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-b2948636_0", { source: ".border-top[data-v-b2948636]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-b2948636]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-b2948636]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-b2948636]{border-left:1px solid rgba(0,0,0,.05)}.image-holder[data-v-b2948636]{background:#111;max-height:50vh;overflow:hidden;display:flex}.color-swatch[data-v-b2948636]{width:36px;height:36px;border-radius:3px;margin:0 1px 1px 0;display:inline-block}", map: undefined, media: undefined });
...
//# sourceMappingURL=audio-a765f466.js.map
