import { ah as FluroContentView, am as FluroTaskList, P as ProcessDots, bo as _, br as _objectSpread2, bm as __vue_normalize__, bn as __vue_create_injector__ } from './index-e1f26c03.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
/* template */
var __vue_render__ = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('flex-column',[(_vm.loading)?[_c('fluro-page-preloader',{attrs:{"contain":""}})]:_c('tabset',{attrs:{"justified":true},scopedSlots:_vm._u([{key:"menuprefix",fn:function(){return [(_vm.context == 'edit' && _vm.$vuetify.breakpoint.mdAndUp)?void 0:_vm._e()]},proxy:true}])},[_vm._v(" "),_c('tab',{attrs:{"heading":"Card Details"}},[_c('flex-row',[_c('v-flex',{staticClass:"main",attrs:{"xs12":"","sm8":""}},[_c('flex-column-body',{staticStyle:{"background":"#fafafa"}},[_c('v-container',[_c('constrain',{attrs:{"sm":""}},[(_vm.reference)?[_c('fluro-panel',[_c('fluro-panel-body',{staticStyle:{"padding":"0"}},[_c('fluro-content-view',{attrs:{"id":_vm.reference,"embedded":true,"definition":_vm.reference.definition,"type":_vm.reference._type}})],1)],1)]:(_vm.definition && _vm.definition.fields && _vm.definition.fields.length)?[_c('fluro-content-form-field',{attrs:{"form-fields":_vm.formFields,"outline":_vm.showOutline,"options":_vm.options,"field":_vm.fieldHash.title},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v;},expression:"model"}}),_vm._v(" "),_c('fluro-content-form',{attrs:{"options":_vm.options,"fields":_vm.definition.fields},model:{value:(_vm.model.data),callback:function ($$v) {_vm.$set(_vm.model, "data", $$v);},expression:"model.data"}})]:[_c('h3',{attrs:{"margin":""}},[_vm._v(_vm._s(_vm.title))]),_vm._v(" "),_c('fluro-content-form-field',{attrs:{"form-fields":_vm.formFields,"outline":_vm.showOutline,"options":_vm.options,"field":_vm.referenceItemField},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v;},expression:"model"}})],_vm._v(" "),(_vm.model.forms && _vm.model.forms.length)?[(_vm.awaitingForms && _vm.awaitingForms.length)?_c('v-input',{staticClass:"no-flex"},[_c('v-label',[_vm._v("Awaiting "+_vm._s(_vm.awaitingForms.length)+" Form Responses")]),_vm._v(" "),_c('p',{staticClass:"help-block"},[_vm._v("These forms have not yet been submitted")]),_vm._v(" "),_c('list-group',_vm._l((_vm.awaitingForms),function(form){return _c('list-group-item',{scopedSlots:_vm._u([{key:"right",fn:function(){return [_c('v-btn',{directives:[{name:"tippy",rawName:"v-tippy"}],attrs:{"small":"","icon":"","loading":_vm.linking[form.form._id],"content":"Link to an existing form submission"},on:{"click":function($event){return _vm.manualLink(form)}}},[_c('fluro-icon',{attrs:{"icon":"link"}})],1),_vm._v(" "),_c('v-btn',{attrs:{"small":"","color":"primary","loading":_vm.resending[form.form._id]},on:{"click":function($event){return _vm.resend(form)}}},[_vm._v("\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tResend\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t"),_c('fluro-icon',{attrs:{"right":"","icon":"paper-plane"}})],1)]},proxy:true}],null,true)},[_c('strong',[_c('fluro-icon',{attrs:{"type":"form"}}),_vm._v(" "+_vm._s(form.form.title)+"\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t")],1),_vm._v(" "),_c('div',{staticClass:"sm"},[_vm._v("\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tSent "+_vm._s(_vm._f("timeago")(form.sent))+" - "),_c('span',{staticClass:"status-label draft"},[_c('fluro-icon',{attrs:{"icon":"clock"}}),_vm._v(" Awaiting form response")],1)])])}),1)],1):_vm._e(),_vm._v(" "),(_vm.receivedForms && _vm.receivedForms.length)?_c('v-input',{staticClass:"no-flex"},[_c('v-label',[_vm._v("Received "+_vm._s(_vm.receivedForms.length)+" Form Response"+_vm._s(_vm.receivedForms.length == 1 ? '' : 's'))]),_vm._v(" "),_vm._l((_vm.receivedForms),function(form,index){return _c('fluro-panel',{key:index},[_c('fluro-panel-title',[_c('strong',[_c('fluro-icon',{attrs:{"type":"form"}}),_vm._v(" "+_vm._s(form.form.title)+"\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t")],1),_vm._v(" "),_c('div',{staticClass:"sm"},[_c('span',{staticClass:"status-label active"},[_c('fluro-icon',{attrs:{"icon":"check"}}),_vm._v(" Received ")],1),_vm._v(" "+_vm._s(_vm._f("formatDate")(form.received,'h:mma ddd MMM YYYY'))+" "),_c('span',{staticClass:"muted"},[_vm._v(_vm._s(_vm._f("timeago")(form.received)))])])]),_vm._v(" "),_c('fluro-panel-body',{staticStyle:{"padding":"0"}},[_c('fluro-content-view',{attrs:{"id":form.interaction,"embedded":true,"definition":form.interaction.definition,"type":"interaction"}})],1)],1)})],2):_vm._e()]:_vm._e(),_vm._v(" "),[_vm._l((_vm.model.taskLists),function(list,index){return _c('fluro-task-list',{attrs:{"card":_vm.model,"state":_vm.model.state,"definition":_vm.definition},on:{"remove":function($event){return _vm.removeTaskList(index)},"input":_vm.dispatchUpdate},model:{value:(_vm.model.taskLists[index]),callback:function ($$v) {_vm.$set(_vm.model.taskLists, index, $$v);},expression:"model.taskLists[index]"}})}),_vm._v(" "),_c('span',{staticClass:"horizontal-rule"}),_vm._v(" "),_c('v-btn',{staticClass:"ml-0",on:{"click":function($event){return _vm.addTaskList()}}},[_vm._v("\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tAdd Task List\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t"),_c('fluro-icon',{attrs:{"right":"","icon":"plus"}})],1)]],2)],1)],1)],1),_vm._v(" "),_c('v-flex',{staticClass:"sidebar",attrs:{"xs12":"","sm4":""}},[_c('flex-column-body',[_c('v-container',[_c('v-input',{staticClass:"no-flex"},[_c('v-label',[_vm._v("Progress")]),_vm._v(" "),_c('div',[_c('process-dots',{attrs:{"definition":_vm.definition},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v;},expression:"model"}})],1)],1),_vm._v(" "),_c('fluro-content-form-field',{attrs:{"form-fields":_vm.formFields,"outline":_vm.showOutline,"options":_vm.options,"field":_vm.fieldHash.dueDate},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v;},expression:"model"}}),_vm._v(" "),_c('fluro-content-form-field',{attrs:{"form-fields":_vm.formFields,"outline":_vm.showOutline,"options":_vm.options,"field":_vm.fieldHash.state},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v;},expression:"model"}}),_vm._v(" "),(_vm.showKeyContacts)?_c('v-input',{staticClass:"no-flex"},[_c('v-label',[_vm._v("Key Contacts")]),_vm._v(" "),_c('p',{staticClass:"help-block"},[_vm._v("This card does not reference a contact, Here you can specify who should be sent Automated SMS and Mailouts as this card progresses")]),_vm._v(" "),_c('fluro-content-form-field',{attrs:{"form-fields":_vm.formFields,"showLabel":false,"outline":_vm.showOutline,"options":_vm.options,"field":_vm.fieldHash.contacts},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v;},expression:"model"}})],1):_vm._e(),_vm._v(" "),_c('v-input',{staticClass:"no-flex"},[_c('v-label',[_vm._v("Assigned To")]),_vm._v(" "),_c('p',{staticClass:"help-block"},[_vm._v("Assign who is in charge of this card")]),_vm._v(" "),_c('fluro-content-form-field',{attrs:{"form-fields":_vm.formFields,"showLabel":false,"outline":_vm.showOutline,"options":_vm.options,"field":_vm.fieldHash.assignedTo},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v;},expression:"model"}})],1)],1)],1)],1)],1)],1)],1)],2)};
var __vue_staticRenderFns__ = [];

  /* style */
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-03c9ae27_0", { source: ".border-top[data-v-03c9ae27]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-03c9ae27]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-03c9ae27]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-03c9ae27]{border-left:1px solid rgba(0,0,0,.05)}.hint[data-v-03c9ae27]{font-size:10px;opacity:.5;color:inherit;display:block}.main[data-v-03c9ae27],.sidebar[data-v-03c9ae27]{flex:1;overflow:hidden;display:flex;flex-direction:column}.horizontal-rule[data-v-03c9ae27]{display:block;border-radius:20px;height:3px;background:rgba(0,0,0,.1);margin:10px 0}.sidebar[data-v-03c9ae27]{background:rgba(0,0,0,.02)}@media (min-width:769px){.sidebar[data-v-03c9ae27]{border-left:1px solid rgba(0,0,0,.05)}}.bordered[data-v-03c9ae27]{border:1px solid rgba(0,0,0,.1);box-shadow:0 2px 4px rgba(0,0,0,.1)}.bordered[data-v-03c9ae27] .tabset-menu{background:#eee}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-03c9ae27";
  /* module identifier */
...
//# sourceMappingURL=process-7f72ceb4.js.map
