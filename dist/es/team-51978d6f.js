import { r as FluroConfirmButton, bm as __vue_normalize__, bn as __vue_create_injector__, bo as _$1, aN as FluroContentForm, aO as FluroContentFormField } from './index-e1f26c03.js';
import 'vue';
...
import { F as FluroExclusiveSelector } from './FluroExclusiveSelector-61598078.js';
  ...
  computed: {
    ...
    genderBreakdown() {
      ...
      _.each(_.get(stats, "data.genders"), function (value, key) {
        labels.push(key.replace(/\w\S*/g, function (txt) {
          return txt.charAt(0).toUpperCase() + txt.substr(1).toLowerCase();
        }));
        data.push(value);
      });

      _.set(returnData, 'model.series[gender]', {
        data,
        labels
...
/* template */
var __vue_render__$4 = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._v(" METRICS DASHBOARD "),(_vm.loading)?[_vm._v(" Loading Component "),_c('v-progress-circular',{attrs:{"indeterminate":""}})]:[_c('h3',[_vm._v("Attendance")]),_vm._v(" "),_c('fluro-chart',{attrs:{"chartType":"line","options":_vm.eventData.options,"series":_vm.eventData.series,"axis":_vm.eventData.axis},model:{value:(_vm.eventData.model),callback:function ($$v) {_vm.$set(_vm.eventData, "model", $$v);},expression:"eventData.model"}}),_vm._v(" "),_c('h3',[_vm._v("Group Size")]),_vm._v(" "),_c('fluro-chart',{attrs:{"chartType":"line","options":_vm.groupSize.options,"series":_vm.groupSize.series,"axis":_vm.groupSize.axis},model:{value:(_vm.groupSize.model),callback:function ($$v) {_vm.$set(_vm.groupSize, "model", $$v);},expression:"groupSize.model"}}),_vm._v(" "),_c('h3',[_vm._v("Gender Breakdown")]),_vm._v(" "),_c('fluro-chart',{attrs:{"chartType":"pie","options":_vm.genderBreakdown.options,"series":_vm.genderBreakdown.series},model:{value:(_vm.genderBreakdown.model),callback:function ($$v) {_vm.$set(_vm.genderBreakdown, "model", $$v);},expression:"genderBreakdown.model"}})]],2)};
var __vue_staticRenderFns__$4 = [];

  /* style */
  const __vue_inject_styles__$4 = function (inject) {
    if (!inject) return
    inject("data-v-188a91bc_0", { source: ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}", map: undefined, media: undefined });
...
var script$5 = {
  components: {
    MetricsDashboard: __vue_component__$4,
...
//# sourceMappingURL=team-51978d6f.js.map
