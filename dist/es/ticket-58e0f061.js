...
var css_248z = ".border-top[data-v-edb4786c]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-edb4786c]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-edb4786c]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-edb4786c]{border-left:1px solid rgba(0,0,0,.05)}.no-border-no-background .toggle-item[data-v-edb4786c]{border:0!important;background:0 0!important;font-size:14px;padding:0}.hint[data-v-edb4786c]{font-size:10px;opacity:.5;color:inherit;display:block}";
...
//# sourceMappingURL=ticket-58e0f061.js.map
