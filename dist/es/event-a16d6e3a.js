import { ag as FluroContentView, bn as _, bl as __vue_normalize__, bm as __vue_create_injector__ } from './index-85430a38.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
import 'moment';
import { F as FluroContentEditMixin } from './FluroContentEditMixin-e90e6c1e.js';
import { T as TicketTypeManager, M as MessagingEventManager, L as LocationSelector } from './TicketTypeManager-25dd4df6.js';
import { G as GuestList, L as LocationViewMapComponent } from './GuestList-d03fd4a9.js';
import { T as TicketList } from './TicketList-3a4c44b0.js';
import 'fluro-vue-ui';
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-2468befa_0", { source: ".border-top[data-v-2468befa]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-2468befa]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-2468befa]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-2468befa]{border-left:1px solid rgba(0,0,0,.05)}.event-cover-image[data-v-2468befa]{border-radius:5px;width:90%;padding-bottom:70%;background-repeat:no-repeat;background-position:center;background-size:cover;display:block;margin:5%}.hint[data-v-2468befa]{font-size:10px;opacity:.5;color:inherit;display:block}.copystring[data-v-2468befa]{width:100%;overflow:auto;display:block;background:#eee;border-radius:3px;opacity:.5;padding:10px;line-height:20px}.copystring[data-v-2468befa]:hover{opacity:1}.assignment-item[data-v-2468befa]{font-size:12px;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;border-radius:100px;margin-bottom:2px;padding:2px 10px;font-weight:500;background-color:rgba(0,0,0,.05)}.assignment-item.confirmed[data-v-2468befa]{color:#4cc650;background-color:rgba(76,198,80,.05)}.assignment-item.denied[data-v-2468befa]{color:#d93e63;background-color:rgba(217,62,99,.05)}.assignment-item.unknown[data-v-2468befa]{color:#555}.assignment-item.proposed[data-v-2468befa]{background-color:rgba(42,212,185,.1);color:#197f6f}.btn-ghost[data-v-2468befa]{border:1px dashed #555;color:#555;opacity:.5}.btn-ghost[data-v-2468befa]:hover{opacity:1}.bordered[data-v-2468befa]{border:1px solid rgba(0,0,0,.1);box-shadow:0 2px 4px rgba(0,0,0,.1)}.bordered[data-v-2468befa] .tabset-menu{background:#eee}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-2468befa";
  /* module identifier */
...
//# sourceMappingURL=event-a16d6e3a.js.map
