...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-bd66f36a_0", { source: ".border-top[data-v-bd66f36a]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-bd66f36a]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-bd66f36a]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-bd66f36a]{border-left:1px solid rgba(0,0,0,.05)}.no-border-no-background .toggle-item[data-v-bd66f36a]{border:none!important;background:0 0!important;font-size:14px;padding:0}.hint[data-v-bd66f36a]{font-size:10px;opacity:.5;color:inherit;display:block}", map: undefined, media: undefined });
...
//# sourceMappingURL=ticket-614950de.js.map
