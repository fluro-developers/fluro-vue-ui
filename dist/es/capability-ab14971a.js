...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-3daf1968_0", { source: ".border-top[data-v-3daf1968]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-3daf1968]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-3daf1968]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-3daf1968]{border-left:1px solid rgba(0,0,0,.05)}.hint[data-v-3daf1968]{font-size:10px;opacity:.5;color:inherit;display:block}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-3daf1968";
  /* module identifier */
...
//# sourceMappingURL=capability-ab14971a.js.map
