import { n as FluroConfirmButton, bf as _$1, bd as __vue_normalize__, be as __vue_create_injector__, aG as FluroExpressionEditor, b as FluroModalMixin, aJ as FluroContentFormField, e as FluroFieldEditor, aB as FluroContentSelectButton, bh as FieldTemplates } from './index-a78a7717.js';
import 'vue';
...
import { F as FluroContentEditMixin } from './FluroContentEditMixin-9e640bf9.js';
...
var __vue_staticRenderFns__$5 = [];
  ...
  const __vue_inject_styles__$5 = function (inject) {
    if (!inject) return
    inject("data-v-074fe25a_0", { source: ".border-top[data-v-074fe25a]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-074fe25a]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-074fe25a]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-074fe25a]{border-left:1px solid rgba(0,0,0,.05)}.field-row[data-v-074fe25a]{padding:0 15px;border-bottom:1px solid rgba(0,0,0,.1)}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$5 = "data-v-074fe25a";
  /* module identifier */
...
//# sourceMappingURL=definition-c5ac1e16.js.map
