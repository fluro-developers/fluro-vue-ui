...
import { F as FluroDefinedList } from './FluroDefinedList-400f1928.js';
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-d4bfd28e_0", { source: ".border-top[data-v-d4bfd28e]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-d4bfd28e]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-d4bfd28e]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-d4bfd28e]{border-left:1px solid rgba(0,0,0,.05)}.image-holder[data-v-d4bfd28e]{background:#111;max-height:50vh;overflow:hidden;display:flex}.color-swatch[data-v-d4bfd28e]{width:36px;height:36px;border-radius:3px;margin:0 1px 1px 0;display:inline-block}", map: undefined, media: undefined });
...
//# sourceMappingURL=image-a4b5d25c.js.map
