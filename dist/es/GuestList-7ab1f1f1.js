import { bg as _$1, bb as __vue_normalize__, bc as __vue_create_injector__, S as SearchInput, L as AvatarCell, n as FluroTable } from './index-f6c3de36.js';
...
var script = {
  ...
  computed: {
    floatPositions() {
      var self = this;
      return _$1.chain(self.positions).filter(function (pos) {
  ...
  methods: {
    ...
    initMarkers() {
      ...
      self.markers = _$1.map(self.floatPositions, function (pos) {
    ...
    createContentString(obj) {
      ...
      if (obj._type == "family") {
        text += "<h5>" + _$1.startCase(obj.title) + " Household</h5>";
        item = obj.address;
      } else {
...
//# sourceMappingURL=GuestList-7ab1f1f1.js.map
