import { m as FluroConfirmButton, bc as __vue_normalize__, bd as __vue_create_injector__, aF as FluroExpressionEditor, a as FluroModalMixin, d as FluroFieldEditor, aA as FluroContentSelectButton, bf as FieldTemplates } from './index-3f9f5bf4.js';
import 'vue';
...
import { F as FluroContentEditMixin } from './FluroContentEditMixin-6cdd09df.js';
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-6df80fff_0", { source: ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}", map: undefined, media: undefined });
...
var __vue_staticRenderFns__$2 = [];
  ...
  const __vue_inject_styles__$2 = function (inject) {
    if (!inject) return
    inject("data-v-28d98efe_0", { source: ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}", map: undefined, media: undefined });
...
var script$3 = {
  components: {
    ...
    PaymentModifierEditor: __vue_component__$2 // FluroEditor,
      ...
      switch (parentType) {
        case 'interaction':
          ...
          if (!self.model.fields || !self.model.fields.length) {
            ...
            var getPersonField = _.find(FieldTemplates, {
              key: 'person'
            });
      ...
      get() {
        ...
        return new Promise(function (resolve, reject) {
          self.$fluro.types.basicTypes().then(function (values) {
            ...
            var cleaned = _.chain(values).compact().map(function (type) {
              return {
                title: type.title,
      ...
      get() {
        ...
        return new Promise(function (resolve, reject) {
          self.$fluro.types.terms().then(function (terms) {
            /////////////////////////
            var mapped = _.chain(terms).values().map(function (term) {
              return {
                name: term.title,
                title: term.title,
...
var update = ref.update;
var options = ref.options;
return [_c('fluro-content-form-field',{attrs:{"form-fields":formFields,"options":options,"field":fieldHash.allowAlternativePayments},on:{"input":update},model:{value:(model),callback:function ($$v) {model=$$v;},expression:"model"}}),_vm._v(" "),(model.allowAlternativePayments)?_c('fluro-panel',{attrs:{"margin":""}},[_c('tabset',{model:{value:(_vm.alternativePaymentMethodIndex),callback:function ($$v) {_vm.alternativePaymentMethodIndex=$$v;},expression:"alternativePaymentMethodIndex"}},_vm._l((_vm.alternativePaymentMethods),function(method,index){return _c('tab',{attrs:{"heading":method.title}},[_c('fluro-panel-body',[_c('fluro-content-form',{attrs:{"fields":_vm.paymentMethodFields},model:{value:(_vm.alternativePaymentMethods[index]),callback:function ($$v) {_vm.$set(_vm.alternativePaymentMethods, index, $$v);},expression:"alternativePaymentMethods[index]"}}),_vm._v(" "),_c('v-layout',[_c('v-spacer'),_vm._v(" "),_c('v-flex',{attrs:{"shrink":""}},[_c('v-btn',{staticClass:"ma-0",attrs:{"small":"","color":"error"},on:{"click":function($event){return _vm.removeAlternativePaymentMethod(method, index)}}},[_vm._v("\n                                                                        Remove "+_vm._s(method.title)+"\n                                                                    ")])],1)],1)],1)],1)}),1),_vm._v(" "),_c('fluro-panel-body',{staticClass:"border-top"},[_c('v-btn',{staticClass:"ma-0",attrs:{"color":"primary"},on:{"click":function($event){return _vm.addAlternativePaymentMethod()}}},[_vm._v("Add additional payment method")])],1)],1):_vm._e()]}}],null,false,3707735241),model:{value:(_vm.model.paymentDetails),callback:function ($$v) {_vm.$set(_vm.model, "paymentDetails", $$v);},expression:"model.paymentDetails"}})]:_vm._e()],2)]},proxy:true}],null,false,2763036044),model:{value:(_vm.model.fields),callback:function ($$v) {_vm.$set(_vm.model, "fields", $$v);},expression:"model.fields"}})],1)]:[_c('tab',{attrs:{"heading":"Configuration"}},[_c('flex-column-body',{staticStyle:{"background":"#fafafa"}},[_c('v-container',{attrs:{"grid-list-xl":""}},[_c('constrain',{attrs:{"sm":""}},[_c('fluro-panel',[_c('fluro-panel-body',[_c('v-layout',[_c('v-flex',{attrs:{"xs12":"","sm6":""}},[_c('fluro-content-form-field',{attrs:{"form-fields":_vm.formFields,"outline":_vm.showOutline,"options":_vm.options,"field":_vm.fieldHash.title},on:{"input":_vm.update},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v;},expression:"model"}})],1),_vm._v(" "),_c('v-flex',{attrs:{"xs12":"","sm6":""}},[_c('fluro-content-form-field',{attrs:{"form-fields":_vm.formFields,"outline":_vm.showOutline,"options":_vm.options,"field":_vm.fieldHash.plural},on:{"input":_vm.update},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v;},expression:"model"}})],1)],1),_vm._v(" "),(!_vm.model._id)?[_c('div',{directives:[{name:"show",rawName:"v-show",value:(_vm.showDefinitionName),expression:"showDefinitionName"}]},[_c('fluro-content-form-field',{attrs:{"form-fields":_vm.formFields,"outline":_vm.showOutline,"options":_vm.options,"field":_vm.fieldHash.definitionName},on:{"input":_vm.update},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v;},expression:"model"}})],1),_vm._v(" "),(_vm.lockedSubType)?void 0:[_c('fluro-content-form-field',{attrs:{"form-fields":_vm.formFields,"outline":_vm.showOutline,"options":_vm.options,"field":_vm.fieldHash.parentType},on:{"input":_vm.update},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v;},expression:"model"}}),_vm._v(" "),_c('fluro-panel',[_c('fluro-panel-body',[_c('v-layout',[_c('v-flex',{attrs:{"xs12":"","sm6":""}},[_c('div',{staticClass:"form-group"},[_c('label',[_vm._v("Definition Name")]),_vm._v(" "),_c('div',[_vm._v(_vm._s(_vm.model.definitionName))])])]),_vm._v(" "),_c('v-flex',{attrs:{"xs12":"","sm6":""}},[_c('div',{staticClass:"form-group"},[_c('label',[_vm._v("Extends type")]),_vm._v(" "),_c('div',[_vm._v(_vm._s(_vm._f("definitionTitle")(_vm.model.parentType)))])])])],1)],1)],1)]]:_vm._e(),_vm._v(" "),_c('fluro-content-form-field',{attrs:{"form-fields":_vm.formFields,"outline":_vm.showOutline,"options":_vm.options,"field":_vm.fieldHash.privacy},on:{"input":_vm.update},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v;},expression:"model"}})],2)],1),_vm._v(" "),(_vm.model.parentType == 'process')?_c('fluro-panel',[_c('fluro-panel-body',[_c('h4',{attrs:{"margin":""}},[_vm._v("Process Board Options")]),_vm._v(" "),_c('fluro-content-form-field',{attrs:{"form-fields":_vm.formFields,"outline":_vm.showOutline,"options":_vm.options,"field":_vm.fieldHash.firstLine},on:{"input":_vm.update},model:{value:(_vm.model),callback:function ($$v) {_vm.model=$$v;},expression:"model"}}),_vm._v(" "),_c('fluro-content-form',{attrs:{"fields":_vm.processFields},model:{value:(_vm.model.data),callback:function ($$v) {_vm.$set(_vm.model, "data", $$v);},expression:"model.data"}})],1)],1):_vm._e()],1)],1)],1)],1),_vm._v(" "),_c('tab',{attrs:{"heading":"Manage Fields"}},[_c('fluro-field-editor',{attrs:{"item":_vm.model},model:{value:(_vm.model.fields),callback:function ($$v) {_vm.$set(_vm.model, "fields", $$v);},expression:"model.fields"}})],1),_vm._v(" "),(_vm.definition && _vm.definition.definitionName != 'form')?_c('tab',{attrs:{"heading":((_vm.definition.title) + " Information")}},[_c('flex-column-body',{staticStyle:{"background":"#fafafa"}},[_c('v-container',[_c('constrain',{attrs:{"sm":""}},[_c('fluro-content-form',{attrs:{"options":_vm.definitionFormOptions,"fields":_vm.definition.fields},model:{value:(_vm.model.data),callback:function ($$v) {_vm.$set(_vm.model, "data", $$v);},expression:"model.data"}})],1)],1)],1)],1):_vm._e(),_vm._v(" "),_c('tab',{attrs:{"heading":"Advanced"}},[_c('flex-column-body',{staticStyle:{"background":"#fafafa"}},[_c('v-container',[_c('constrain',{attrs:{"sm":""}},[(_vm.model.parentType != 'realm')?_c('fluro-panel',[_c('fluro-panel-title',[_c('h5',[_vm._v("Restrict To Realms")]),_vm._v(" "),_c('div',{staticClass:"muted"},[_vm._v("Select which realms these "+_vm._s(_vm._f("definitionTitle")(_vm.model.parentType,true))+" can be created in")])]),_vm._v(" "),_c('fluro-panel-body',[_c('fluro-realm-select',{model:{value:(_vm.model.restrictRealms),callback:function ($$v) {_vm.$set(_vm.model, "restrictRealms", $$v);},expression:"model.restrictRealms"}})],1)],1):_vm._e(),_vm._v(" "),_c('fluro-panel',[_c('fluro-panel-title',[_c('h5',[_vm._v("Display Columns")]),_vm._v(" "),_c('div',{staticClass:"muted"},[_vm._v("Select columns to show when listing these "+_vm._s(_vm._f("definitionTitle")(_vm.model.parentType,true)))])]),_vm._v(" "),_c('fluro-panel-body',[_vm._v("\n                                        Adjust columns\n                                    ")])],1)],1)],1)],1)],1)]],2)]],2)};
var __vue_staticRenderFns__$3 = [];

  /* style */
  const __vue_inject_styles__$3 = function (inject) {
    if (!inject) return
    inject("data-v-847ecad6_0", { source: ".border-top[data-v-847ecad6]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-847ecad6]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-847ecad6]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-847ecad6]{border-left:1px solid rgba(0,0,0,.05)}.field-row[data-v-847ecad6]{padding:0 15px;border-bottom:1px solid rgba(0,0,0,.1)}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$3 = "data-v-847ecad6";
  /* module identifier */
...
//# sourceMappingURL=definition-8f9a42aa.js.map
