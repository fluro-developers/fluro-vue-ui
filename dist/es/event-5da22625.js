import { ae as FluroContentView, bh as _, bf as styleInject, bg as __vue_normalize__ } from './index-7b32a04b.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
import { T as TicketTypeManager, M as MessagingEventManager, L as LocationSelector } from './TicketTypeManager-9464365f.js';
import { G as GuestList, L as LocationViewMapComponent } from './GuestList-122d9c6b.js';
import { T as TicketList } from './TicketList-c0633336.js';
...
var css_248z = ".border-top[data-v-6ba11775]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-6ba11775]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-6ba11775]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-6ba11775]{border-left:1px solid rgba(0,0,0,.05)}.event-cover-image[data-v-6ba11775]{border-radius:5px;width:90%;padding-bottom:70%;background-repeat:no-repeat;background-position:center;background-size:cover;display:block;margin:5%}.hint[data-v-6ba11775]{font-size:10px;opacity:.5;color:inherit;display:block}.copystring[data-v-6ba11775]{width:100%;overflow:auto;display:block;background:#eee;border-radius:3px;opacity:.5;padding:10px;line-height:20px}.copystring[data-v-6ba11775]:hover{opacity:1}.assignment-item[data-v-6ba11775]{font-size:12px;-o-text-overflow:ellipsis;text-overflow:ellipsis;white-space:nowrap;overflow:hidden;border-radius:100px;margin-bottom:2px;padding:2px 10px;font-weight:500;background-color:rgba(0,0,0,.05)}.assignment-item.confirmed[data-v-6ba11775]{color:#4cc650;background-color:rgba(76,198,80,.05)}.assignment-item.denied[data-v-6ba11775]{color:#d93e63;background-color:rgba(217,62,99,.05)}.assignment-item.unknown[data-v-6ba11775]{color:#555}.assignment-item.proposed[data-v-6ba11775]{background-color:rgba(42,212,185,.1);color:#197f6f}.btn-ghost[data-v-6ba11775]{border:1px dashed #555;color:#555;opacity:.5}.btn-ghost[data-v-6ba11775]:hover{opacity:1}.bordered[data-v-6ba11775]{border:1px solid rgba(0,0,0,.1);-webkit-box-shadow:0 2px 4px rgba(0,0,0,.1);box-shadow:0 2px 4px rgba(0,0,0,.1)}.bordered[data-v-6ba11775] .tabset-menu{background:#eee}";
...
var __vue_staticRenderFns__ = [];
  ...
  /* scoped */
  const __vue_scope_id__ = "data-v-6ba11775";
  /* module identifier */
...
//# sourceMappingURL=event-5da22625.js.map
