import { ae as FluroContentView, aj as FluroTaskList, bh as _, bk as _objectSpread2, bf as styleInject, bg as __vue_normalize__ } from './index-9c9e4101.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
var css_248z = ".border-top[data-v-3f356a49]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-3f356a49]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-3f356a49]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-3f356a49]{border-left:1px solid rgba(0,0,0,.05)}.hint[data-v-3f356a49]{font-size:10px;opacity:.5;color:inherit;display:block}.main[data-v-3f356a49],.sidebar[data-v-3f356a49]{-webkit-box-flex:1;-ms-flex:1;flex:1;overflow:hidden;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column}.horizontal-rule[data-v-3f356a49]{display:block;border-radius:20px;height:3px;background:rgba(0,0,0,.1);margin:10px 0}.sidebar[data-v-3f356a49]{background:rgba(0,0,0,.02)}@media (min-width:769px){.sidebar[data-v-3f356a49]{border-left:1px solid rgba(0,0,0,.05)}}.bordered[data-v-3f356a49]{border:1px solid rgba(0,0,0,.1);-webkit-box-shadow:0 2px 4px rgba(0,0,0,.1);box-shadow:0 2px 4px rgba(0,0,0,.1)}.bordered[data-v-3f356a49] .tabset-menu{background:#eee}";
...
var __vue_staticRenderFns__ = [];
  ...
  /* scoped */
  const __vue_scope_id__ = "data-v-3f356a49";
  /* module identifier */
...
//# sourceMappingURL=process-9cbd6c2f.js.map
