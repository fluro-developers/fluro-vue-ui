import { aB as FluroRealmSelect, aA as FluroContentSelectButton, bc as __vue_normalize__, bd as __vue_create_injector__ } from './index-0fbca871.js';
import 'vue';
...
var __vue_staticRenderFns__ = [function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('thead',[_c('tr',[_c('th',{staticClass:"column"},[_vm._v("Role")]),_vm._v(" "),_c('th',{staticClass:"column"},[_vm._v("Realms")]),_vm._v(" "),_c('th',[_vm._v(" ")])])])}];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-65b0dd54_0", { source: ".border-top[data-v-65b0dd54]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-65b0dd54]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-65b0dd54]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-65b0dd54]{border-left:1px solid rgba(0,0,0,.05)}.table[data-v-65b0dd54]{background:#fff;width:100%;border-collapse:collapse;padding:0;margin:0;border:1px solid rgba(0,0,0,.1);box-shadow:0 1px 1px rgba(0,0,0,.1);margin-bottom:25px}.table thead[data-v-65b0dd54]{text-transform:uppercase;letter-spacing:.03em;font-weight:500;font-size:12px}.table td[data-v-65b0dd54],.table th[data-v-65b0dd54]{padding:10px;text-align:left;border-bottom:1px solid rgba(0,0,0,.1);vertical-align:middle}.table td.column[data-v-65b0dd54],.table th.column[data-v-65b0dd54]{width:50%}.table th[data-v-65b0dd54]{background:rgba(0,0,0,.05)}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-65b0dd54";
  /* module identifier */
...
//# sourceMappingURL=FluroPermissionSelect-e3867f21.js.map
