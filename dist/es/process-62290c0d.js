import { ac as FluroContentView, ah as FluroTaskList, bf as _, bi as _objectSpread2, bd as __vue_normalize__, be as __vue_create_injector__ } from './index-6dde7e0b.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-7aa263ce_0", { source: ".border-top[data-v-7aa263ce]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-7aa263ce]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-7aa263ce]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-7aa263ce]{border-left:1px solid rgba(0,0,0,.05)}.hint[data-v-7aa263ce]{font-size:10px;opacity:.5;color:inherit;display:block}.main[data-v-7aa263ce],.sidebar[data-v-7aa263ce]{flex:1;overflow:hidden;display:flex;flex-direction:column}.horizontal-rule[data-v-7aa263ce]{display:block;border-radius:20px;height:3px;background:rgba(0,0,0,.1);margin:10px 0}.sidebar[data-v-7aa263ce]{background:rgba(0,0,0,.02)}@media (min-width:769px){.sidebar[data-v-7aa263ce]{border-left:1px solid rgba(0,0,0,.05)}}.bordered[data-v-7aa263ce]{border:1px solid rgba(0,0,0,.1);box-shadow:0 2px 4px rgba(0,0,0,.1)}.bordered[data-v-7aa263ce] .tabset-menu{background:#eee}", map: undefined, media: undefined });
...
//# sourceMappingURL=process-62290c0d.js.map
