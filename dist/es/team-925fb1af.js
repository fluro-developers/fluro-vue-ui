...
import { r as FluroConfirmButton, bm as __vue_normalize__, bn as __vue_create_injector__, bo as _$1, aN as FluroContentForm, aO as FluroContentFormField } from './index-f3aeea21.js';
...
import { F as FluroExclusiveSelector } from './FluroExclusiveSelector-ccffa552.js';
...
var script$4 = {
  ...
  computed: {
    eventData() {
      ...
      _.each(self.model.events, function (event) {
...
__vue_render__$4._withStripped = true;
  ...
  const __vue_inject_styles__$4 = function (inject) {
    if (!inject) return
    inject("data-v-0de522c6_0", { source: "/**/\n.border-top {\n  border-top: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-right {\n  border-right: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-bottom {\n  border-bottom: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-left {\n  border-left: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n/**/\n\n/*# sourceMappingURL=MetricsDashboard.vue.map */", map: {"version":3,"sources":["C:\\Users\\User\\Documents\\fluro\\fluro-vue-ui\\src\\components\\MetricsDashboard.vue","MetricsDashboard.vue"],"names":[],"mappings":"AAqHA,GAAA;AAYA;EACA,yCAAA;AC/HA;ADkIA;EACA,2CAAA;AC/HA;ADkIA;EACA,4CAAA;AC/HA;ADkIA;EACA,0CAAA;AC/HA;;ADuIA,GAAA;;ACnIA,+CAA+C","file":"MetricsDashboard.vue","sourcesContent":["<template>\n    <div> METRICS DASHBOARD\n        <template v-if=\"loading\"> Loading Component <v-progress-circular indeterminate></v-progress-circular>\n        </template>\n        <template v-else>\n            <fluro-chart chartType=\"area\" :options=\"{}\" v-model=\"eventData.model\" :series=\"eventData.series\" :axis=\"eventData.axis\" />\n        <!-- Type: {{type}}  --> \n        <!-- Model:<pre>{{eventData}}</pre> -->\n        <!-- ID: {{id}} -->\n        </template>\n    </div> \n</template>\n<script>\nimport { moment } from 'fluro';\nimport { FluroChart } from 'fluro-vue-ui';\nexport default {\n    components: {\n        FluroChart,\n    },\n    props: {\n        id: {\n            type: [Object, String],\n        },\n        type: {\n            type: String,\n        }\n    },\n    computed: {\n        eventData() {\n            var self = this\n            var model = {\n                axis: [],\n                series: {\n                    headcount: [],\n                    checkins: [],\n                    expected: [],\n                }\n            }\n            \n            _.each(self.model.events, function(event) {\n                \n                //console.log(\"HERE\", event)\n                model.axis.push(event.startDate)\n                model.series.headcount.push(_.get(event, \"headcount.average\") || 0)\n                model.series.checkins.push(_.get(event, \"checkins.length\") || 0)\n                model.series.expected.push(_.get(event, \"stats.guestExpected\") || 0)\n\n            })\n\n\n            return {\n                axis: {\n                  \"title\": \"Date\",\n                  \"key\": \"date\"\n                },\n                series:  [\n                  {\n                    \"title\": \"Headcount\",\n                    \"key\": \"headcount\"\n                  },\n                  {\n                    \"title\": \"Checkins\",\n                    \"key\": \"checkins\",\n                  },\n                  {\n                    \"title\": \"Expected\",\n                    \"key\": \"expected\",\n                  },\n\n                ],\n                model\n            }\n         }   \n    },\n    asyncComputed: {\n        model: {\n            // default: {},\n            get() {\n                var self = this;\n                var id = self.$fluro.utils.getStringID(self.id);\n                return new Promise(function(resolve, reject) {\n                    //Load the chart data\n                    switch (self.type) {\n                        case 'team':\n                            var endpoint = `chart/groups/${id}/simple`\n                            self.$fluro.api.get(endpoint, {\n                                params: {\n                                    startDate: moment().subtract(1, 'year').toDate(),\n                                    endDate: moment().toDate(),\n                                }\n                            }).then(function(res) {\n                                resolve(res.data);\n                                self.loading = false;\n                            }, function(err) {\n                                reject(err);\n                                self.loading = false;\n                            });\n                            break;\n                        case 'realm':\n                            break;\n                        case 'contact':\n                            break;\n                    }\n                })\n            }\n        }\n    },\n    data() {\n        return { \n            loading: true,\n        }\n    }\n}\n\n</script>\n<style lang=\"scss\">\n\n/**/\r\n\r\n$primary: #2ad4b9;//#0bd6be;\r\n$success: #4cc650; //#4cc673;//\r\n$warning: #f0974e; //darken(#fbf2d2, 50%);//#f0974e;\r\n$danger: #d93e63;\r\n$secondary: #0bd6cd; //#0bd6a3;\r\n\r\n\r\n\r\n//////////////////////////////////////////\r\n\r\n.border-top {\r\n    border-top: 1px solid rgba(#000, 0.05);\r\n}\r\n\r\n.border-right {\r\n    border-right: 1px solid rgba(#000, 0.05);\r\n}\r\n\r\n.border-bottom {\r\n    border-bottom: 1px solid rgba(#000, 0.05);\r\n}\r\n\r\n.border-left {\r\n    border-left: 1px solid rgba(#000, 0.05);\r\n}\r\n//////////////////////////////////////////\r\n\r\n\r\n\r\n\r\n//////////////////////////////////////////\r\n/**/\n</style>\n","/**/\n.border-top {\n  border-top: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-right {\n  border-right: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-bottom {\n  border-bottom: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-left {\n  border-left: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n/**/\n\n/*# sourceMappingURL=MetricsDashboard.vue.map */"]}, media: undefined });
...
//# sourceMappingURL=team-925fb1af.js.map
