<<<<<<< HEAD:dist/es/process-3d94dad3.js
import { ae as FluroContentView, aj as FluroTaskList, bh as _, bk as _objectSpread2, bf as __vue_normalize__, bg as __vue_create_injector__ } from './index-204ee3c0.js';
=======
import { af as FluroContentView, ak as FluroTaskList, bi as _, bl as _objectSpread2, bg as __vue_normalize__, bh as __vue_create_injector__ } from './index-8d7f8f94.js';
>>>>>>> e97e30815b0dc9fa78df2edbb47266484ec56bb6:dist/es/process-791cfe19.js
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-c98a3738_0", { source: ".border-top[data-v-c98a3738]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-c98a3738]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-c98a3738]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-c98a3738]{border-left:1px solid rgba(0,0,0,.05)}.hint[data-v-c98a3738]{font-size:10px;opacity:.5;color:inherit;display:block}.main[data-v-c98a3738],.sidebar[data-v-c98a3738]{flex:1;overflow:hidden;display:flex;flex-direction:column}.horizontal-rule[data-v-c98a3738]{display:block;border-radius:20px;height:3px;background:rgba(0,0,0,.1);margin:10px 0}.sidebar[data-v-c98a3738]{background:rgba(0,0,0,.02)}@media (min-width:769px){.sidebar[data-v-c98a3738]{border-left:1px solid rgba(0,0,0,.05)}}.bordered[data-v-c98a3738]{border:1px solid rgba(0,0,0,.1);box-shadow:0 2px 4px rgba(0,0,0,.1)}.bordered[data-v-c98a3738] .tabset-menu{background:#eee}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-c98a3738";
  /* module identifier */
...
<<<<<<< HEAD:dist/es/process-3d94dad3.js
//# sourceMappingURL=process-3d94dad3.js.map
=======
//# sourceMappingURL=process-791cfe19.js.map
>>>>>>> e97e30815b0dc9fa78df2edbb47266484ec56bb6:dist/es/process-791cfe19.js
