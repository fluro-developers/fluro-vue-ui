import { ak as FluroRealmDots, aA as FluroContentSelectButton, bb as FluroSelectionMixin, bc as __vue_normalize__, bd as __vue_create_injector__, c as FluroAvatarUpdate, aB as FluroRealmSelect } from './index-0fbca871.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
import { F as FluroPermissionSelect } from './FluroPermissionSelect-e3867f21.js';
...
var __vue_staticRenderFns__$1 = [];
  ...
  const __vue_inject_styles__$1 = function (inject) {
    if (!inject) return
    inject("data-v-40a4cd28_0", { source: ".border-top[data-v-40a4cd28]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-40a4cd28]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-40a4cd28]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-40a4cd28]{border-left:1px solid rgba(0,0,0,.05)}.hint[data-v-40a4cd28]{font-size:10px;opacity:.5;color:inherit;display:block}.bordered[data-v-40a4cd28]{border:1px solid rgba(0,0,0,.1);box-shadow:0 2px 4px rgba(0,0,0,.1)}.bordered[data-v-40a4cd28] .tabset-menu{background:#eee}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$1 = "data-v-40a4cd28";
  /* module identifier */
...
//# sourceMappingURL=persona-cfc3a56a.js.map
