import { b3 as MailoutRenderPreview, b4 as MailoutTestPanel, b5 as MailoutPreflightPanel, b6 as MailoutResultsPanel, bc as __vue_normalize__, bd as __vue_create_injector__ } from './index-0fbca871.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-5e727e3d_0", { source: ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}.mailout-recipients .collapsed{color:rgba(0,0,0,.4)}.mailout-recipients .collapsed .chevron{transition:all .3s;transform:rotate(-90deg)}", map: undefined, media: undefined });
...
//# sourceMappingURL=mailout-a6b0408a.js.map
