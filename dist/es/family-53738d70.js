import { aI as FluroContentForm, aJ as FluroContentFormField, ao as FluroStatusSelect, c as FluroAvatar, bf as _, bd as __vue_normalize__, be as __vue_create_injector__, aM as FluroAcademicSelect } from './index-6d63e94d.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
import { A as AddressManager } from './AddressManager-6ab1bde0.js';
...
var __vue_staticRenderFns__$1 = [];
  ...
  const __vue_inject_styles__$1 = function (inject) {
    if (!inject) return
    inject("data-v-8935fe8e_0", { source: ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}.no-border-no-background .toggle-item{border:none!important;background:0 0!important;font-size:14px;padding:0}.cards{width:200px!important;background-color:#fff;margin:10px}.border{border-color:rgba(0,0,0,.05);border-style:solid;border-width:1px}.ghost-card{padding:16px;width:200px!important;margin:10px;border:1px dashed #ccc;color:inherit;background-color:transparent;transition:background-color .3s}.ghost-card:hover{background-color:#fff}.add-circle{border:1px dashed #ccc;border-radius:50%;height:132.8px;width:132.8px;padding:8px;margin:auto;display:flex;justify-content:center;align-items:center}.filler-ghost{height:100%;display:block}.add-icon{width:100%;height:100%}.add-contact-text{text-align:center;padding-top:16px}", map: undefined, media: undefined });
...
//# sourceMappingURL=family-53738d70.js.map
