...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-807339b4_0", { source: ".border-top[data-v-807339b4]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-807339b4]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-807339b4]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-807339b4]{border-left:1px solid rgba(0,0,0,.05)}a[data-v-807339b4]{color:inherit;text-decoration:none;cursor:pointer}", map: undefined, media: undefined });
...
//# sourceMappingURL=family-11ca3968.js.map
