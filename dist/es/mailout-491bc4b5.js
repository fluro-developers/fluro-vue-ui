import { b6 as MailoutRenderPreview, b7 as MailoutTestPanel, b8 as MailoutPreflightPanel, b9 as MailoutResultsPanel, bf as styleInject, bg as __vue_normalize__ } from './index-5bdbb7f0.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
var css_248z = ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}.mailout-recipients .collapsed{color:rgba(0,0,0,.4)}.mailout-recipients .collapsed .chevron{-webkit-transition:all .3s;-o-transition:all .3s;transition:all .3s;-webkit-transform:rotate(-90deg);-ms-transform:rotate(-90deg);transform:rotate(-90deg)}";
...
//# sourceMappingURL=mailout-491bc4b5.js.map
