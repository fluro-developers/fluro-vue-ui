import { p as FluroConfirmButton, bf as __vue_normalize__, bg as __vue_create_injector__, bh as _$1, aK as FluroContentForm, aL as FluroContentFormField } from './index-87fb1a77.js';
import 'vue';
...
var __vue_staticRenderFns__$4 = [];
  ...
  const __vue_inject_styles__$4 = function (inject) {
    if (!inject) return
    inject("data-v-16007ef1_0", { source: ".no-border-no-background .toggle-item{border:none!important;background:0 0!important;font-size:14px;padding:0}", map: undefined, media: undefined });
...
//# sourceMappingURL=team-cef57b6d.js.map
