...
import { r as FluroConfirmButton, bm as __vue_normalize__, bn as __vue_create_injector__, bo as _$1, aN as FluroContentForm, aO as FluroContentFormField } from './index-21934d5e.js';
...
import 'moment';
import { F as FluroContentEditMixin } from './FluroContentEditMixin-b944fb31.js';
import { FluroChart } from 'fluro-vue-ui';
import { F as FluroExclusiveSelector } from './FluroExclusiveSelector-4ef73309.js';
...
var script$4 = {
  ...
  computed: {
    ...
    ageSpread() {
      ...
      var groupedAges = _.reduce(ageSpread, function (set, value, key) {
        switch (true) {
          case value < 16:
            set[0] = set[0] + 1;
            break;
  ...
  return _c(
    ...
    [
      _vm.loading
        ...
        : [
            _vm.eventData.model.data.attendance.length
              ? _c(
                  "div",
                  [
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.groupSize.model.data.groupsize.length
              ? _c(
                  "div",
                  [
            ...
            _vm.groupSize.model.data.groupsize.length
              ...
              : _vm._e(),
            _vm._v(" "),
            _vm.ageSpread.model.data.agespread.length
              ? _c(
                  "div",
                  [
                    _c("h3", [_vm._v("Gender Breakdown")]),
...
//# sourceMappingURL=team-af94f958.js.map
