import { ah as FluroContentRender, bf as styleInject, bg as __vue_normalize__ } from './index-e8733ce0.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
import { F as FluroDefinedList } from './FluroDefinedList-7b9983e3.js';
...
var css_248z = ".border-top[data-v-1037348b]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-1037348b]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-1037348b]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-1037348b]{border-left:1px solid rgba(0,0,0,.05)}.image-holder[data-v-1037348b]{background:#111;max-height:50vh;overflow:hidden;display:-webkit-box;display:-ms-flexbox;display:flex}.color-swatch[data-v-1037348b]{width:36px;height:36px;border-radius:3px;margin:0 1px 1px 0;display:inline-block}";
...
//# sourceMappingURL=asset-d3c79f68.js.map
