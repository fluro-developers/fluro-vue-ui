import { p as FluroConfirmButton, bf as styleInject, bg as __vue_normalize__, bh as _$1, aK as FluroContentForm, aL as FluroContentFormField } from './index-83d7f2e4.js';
import 'vue';
...
import { F as FluroExclusiveSelector } from './FluroExclusiveSelector-60a15242.js';
...
var css_248z = ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}.ghost-dragging-class{opacity:.5;background:#c8ebfb}.fade-enter-active,.fade-leave-active{-webkit-transition:all 1s;-o-transition:all 1s;transition:all 1s}.fade-enter,.fade-leave-to{opacity:0}.hover-grey{background:#fafafa}";
...
var css_248z$1 = ".capitalize-text{text-transform:capitalize}";
...
var css_248z$2 = ".border-top{border-top:1px solid rgba(0,0,0,.05)}.border-right{border-right:1px solid rgba(0,0,0,.05)}.border-bottom{border-bottom:1px solid rgba(0,0,0,.05)}.border-left{border-left:1px solid rgba(0,0,0,.05)}.full-width{width:100%}.fade-enter-active,.fade-leave-active{-webkit-transition:all 1s;-o-transition:all 1s;transition:all 1s}.fade-enter,.fade-leave-to{opacity:0}";
...
var css_248z$4 = ".no-border-no-background .toggle-item{border:0!important;background:0 0!important;font-size:14px;padding:0}";
...
//# sourceMappingURL=team-8ec759d0.js.map
