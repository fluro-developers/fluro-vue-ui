...
var css_248z = ".border-top[data-v-3daf1968]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-3daf1968]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-3daf1968]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-3daf1968]{border-left:1px solid rgba(0,0,0,.05)}.hint[data-v-3daf1968]{font-size:10px;opacity:.5;color:inherit;display:block}";
...
//# sourceMappingURL=capability-b57dcabb.js.map
