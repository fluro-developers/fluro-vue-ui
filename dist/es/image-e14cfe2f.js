...
import { F as FluroDefinedList } from './FluroDefinedList-5e46062d.js';
...
var css_248z = ".border-top[data-v-d4bfd28e]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-d4bfd28e]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-d4bfd28e]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-d4bfd28e]{border-left:1px solid rgba(0,0,0,.05)}.image-holder[data-v-d4bfd28e]{background:#111;max-height:50vh;overflow:hidden;display:-webkit-box;display:-ms-flexbox;display:flex}.color-swatch[data-v-d4bfd28e]{width:36px;height:36px;border-radius:3px;margin:0 1px 1px 0;display:inline-block}";
...
var __vue_staticRenderFns__ = [];
  ...
  /* scoped */
  const __vue_scope_id__ = "data-v-d4bfd28e";
  /* module identifier */
...
//# sourceMappingURL=image-e14cfe2f.js.map
