import { l as FluroConfirmButton, bb as __vue_normalize__, bc as __vue_create_injector__, aE as FluroExpressionEditor, a as FluroModalMixin, d as FluroFieldEditor, az as FluroContentSelectButton, be as FieldTemplates } from './index-2a8dcbb7.js';
import 'vue';
...
import { F as FluroContentEditMixin } from './FluroContentEditMixin-3ca17add.js';
...
var __vue_staticRenderFns__$3 = [];
  ...
  const __vue_inject_styles__$3 = function (inject) {
    if (!inject) return
    inject("data-v-33fecbbe_0", { source: ".border-top[data-v-33fecbbe]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-33fecbbe]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-33fecbbe]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-33fecbbe]{border-left:1px solid rgba(0,0,0,.05)}.field-row[data-v-33fecbbe]{padding:0 15px;border-bottom:1px solid rgba(0,0,0,.1)}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__$3 = "data-v-33fecbbe";
  /* module identifier */
...
//# sourceMappingURL=definition-386593fe.js.map
