import { d as FluroAvatar, bc as FluroContactCommunicateMixin, be as styleInject, bf as __vue_normalize__ } from './index-78607ce6.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
var css_248z = ".border-top[data-v-3527f034]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-3527f034]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-3527f034]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-3527f034]{border-left:1px solid rgba(0,0,0,.05)}";
...
//# sourceMappingURL=contact-89872e8c.js.map
