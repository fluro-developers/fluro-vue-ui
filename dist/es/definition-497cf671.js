...
import { p as FluroConfirmButton, bh as _$1, bf as __vue_normalize__, bg as __vue_create_injector__, b as FluroHelp, aI as FluroExpressionEditor, d as FluroModalMixin, aL as FluroContentFormField, g as FluroFieldEditor, aD as FluroContentSelectButton, bj as FieldTemplates } from './index-a97a8088.js';
import 'vue';
...
__vue_render__$5._withStripped = true;
  ...
  const __vue_inject_styles__$5 = function (inject) {
    if (!inject) return
    inject("data-v-225ff770_0", { source: "/**/\n.border-top {\n  border-top: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-right {\n  border-right: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-bottom {\n  border-bottom: 1px solid rgba(0, 0, 0, 0.05);\n}\n.border-left {\n  border-left: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n/**/\n\n/*# sourceMappingURL=FluroColumnSelect.vue.map */", map: {"version":3,"sources":["/Users/jamessandison/git/fluro-vue-ui/src/components/content/edit/components/FluroColumnSelect.vue","FluroColumnSelect.vue"],"names":[],"mappings":"AAqDA,GAAA;AAYA;EACA,yCAAA;AC/DA;ADkEA;EACA,2CAAA;AC/DA;ADkEA;EACA,4CAAA;AC/DA;ADkEA;EACA,0CAAA;AC/DA;;ADuEA,GAAA;;ACnEA,gDAAgD","file":"FluroColumnSelect.vue","sourcesContent":["<template>\n\t\t\t\t<fluro-panel >\n\t\t\t\t\t\t\t\t<fluro-panel-body class=\"border-bottom\" :key=\"index\" v-for=\"(column, index) in model\">\n\t\t\t\t\t\t\t\t\t\t\t\t<fluro-column-select-item v-model=\"model[index]\" />\n\t\t\t\t\t\t\t\t</fluro-panel-body>\n\t\t\t\t\t\t\t\t<fluro-panel-body>\n\t\t\t\t\t\t\t\t\t\t\t\t<v-btn @click=\"add()\">Add item</v-btn>\n\n\t\t\t\t\t\t\t\t</fluro-panel-body>\n\t\t\t\t</fluro-panel>\n</template>\n<script>\nimport FluroColumnSelectItem from 'src/components/content/edit/components/FluroColumnSelectItem.vue';\n\nexport default {\n\t\t\t\tprops: {\n\t\t\t\t\t\t\t\tvalue: {\n\t\t\t\t\t\t\t\t\t\t\t\ttype: Array,\n\t\t\t\t\t\t\t\t\t\t\t\tdefault () {\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\treturn [];\n\t\t\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t}\n\t\t\t\t},\n\t\t\t\tdata() {\n\t\t\t\t\t\t\t\treturn {\n\t\t\t\t\t\t\t\t\t\t\t\tmodel: this.value,\n\t\t\t\t\t\t\t\t}\n\t\t\t\t},\n\t\t\t\tcomponents: {\n\t\t\t\t\t\t\t\tFluroColumnSelectItem,\n\t\t\t\t},\n\t\t\t\tmethods: {\n\t\t\t\t\t\t\t\tadd() {\n\t\t\t\t\t\t\t\t\t\t\t\tthis.model.push({});\n\t\t\t\t\t\t\t\t},\n\t\t\t\t},\n\t\t\t\tcomputed: {},\n\t\t\t\twatch: {\n\t\t\t\t\t\t\t\tvalue(v) {\n\t\t\t\t\t\t\t\t\t\t\t\tif (v != this.model) {\n\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tthis.model = v;\n\t\t\t\t\t\t\t\t\t\t\t\t}\n\t\t\t\t\t\t\t\t},\n\t\t\t\t\t\t\t\tmodel(v) {\n\t\t\t\t\t\t\t\t\t\t\t\tthis.$emit('input', v);\n\t\t\t\t\t\t\t\t}\n\t\t\t\t},\n\n}\n\n</script>\n<style lang=\"scss\">\n\n/**/\n\n$primary: #2ad4b9;//#0bd6be;\n$success: #4cc650; //#4cc673;//\n$warning: #f0974e; //darken(#fbf2d2, 50%);//#f0974e;\n$danger: #d93e63;\n$secondary: #0bd6cd; //#0bd6a3;\n\n\n\n//////////////////////////////////////////\n\n.border-top {\n    border-top: 1px solid rgba(#000, 0.05);\n}\n\n.border-right {\n    border-right: 1px solid rgba(#000, 0.05);\n}\n\n.border-bottom {\n    border-bottom: 1px solid rgba(#000, 0.05);\n}\n\n.border-left {\n    border-left: 1px solid rgba(#000, 0.05);\n}\n//////////////////////////////////////////\n\n\n\n\n//////////////////////////////////////////\n/**/\n</style>\n","/**/\n.border-top {\n  border-top: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-right {\n  border-right: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-bottom {\n  border-bottom: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n.border-left {\n  border-left: 1px solid rgba(0, 0, 0, 0.05);\n}\n\n/**/\n\n/*# sourceMappingURL=FluroColumnSelect.vue.map */"]}, media: undefined });
...
//# sourceMappingURL=definition-497cf671.js.map
