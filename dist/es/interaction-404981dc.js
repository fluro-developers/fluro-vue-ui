...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-787340f8_0", { source: ".border-top[data-v-787340f8]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-787340f8]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-787340f8]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-787340f8]{border-left:1px solid rgba(0,0,0,.05)}.qrcode[data-v-787340f8]{display:block;border:5px solid #000;background:#000;margin:auto}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-787340f8";
  /* module identifier */
...
//# sourceMappingURL=interaction-404981dc.js.map
