import { a3 as FluroToggleItem, S as SearchInput, be as _, bc as __vue_normalize__, bd as __vue_create_injector__ } from './index-49990ec3.js';
import 'vue';
import 'vuedraggable';
import 'vue-color';
...
var __vue_staticRenderFns__ = [];
  ...
  const __vue_inject_styles__ = function (inject) {
    if (!inject) return
    inject("data-v-5b7c2952_0", { source: ".border-top[data-v-5b7c2952]{border-top:1px solid rgba(0,0,0,.05)}.border-right[data-v-5b7c2952]{border-right:1px solid rgba(0,0,0,.05)}.border-bottom[data-v-5b7c2952]{border-bottom:1px solid rgba(0,0,0,.05)}.border-left[data-v-5b7c2952]{border-left:1px solid rgba(0,0,0,.05)}.search-box[data-v-5b7c2952]{padding:10px}", map: undefined, media: undefined });

  };
  /* scoped */
  const __vue_scope_id__ = "data-v-5b7c2952";
  /* module identifier */
...
//# sourceMappingURL=role-9dc74c32.js.map
